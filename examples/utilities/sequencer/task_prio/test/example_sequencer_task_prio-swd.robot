...
Example Step 1-2
    ...
    Comment    Check that that the initialization function (app_init()) runs without errors
...
Example Step 6
    ...
    Check Integer Variable    ExecStatus    ${EXEC_STATUS_INIT_OK}
    Check Integer Variable    HighFreqToggleCounter    35    40    timeout=6s
    Sleep    4s
    Check Integer Variable    LowFreqToggleCounter    3    5    timeout=7s
