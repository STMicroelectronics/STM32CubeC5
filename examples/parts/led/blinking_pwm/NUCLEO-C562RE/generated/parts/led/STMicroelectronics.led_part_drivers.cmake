...
set(generated_STMicroelectronics.led_part_drivers.0.0.1_LED_CFG_Condition "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:Board Part#.*Cgroup:LED#.*Csub:PWM(#.*|$)>,>>")
...
if("Cvendor:STMicroelectronics#Cclass:Board Part#Cgroup:STM32CubeMX2 Config#Csub:LED#Cversion:1.0.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  ...
  target_sources(generated_STMicroelectronics_led_part_drivers_0_0_1 INTERFACE "$<${generated_STMicroelectronics.led_part_drivers.0.0.1_LED_CFG_Condition}:${CMAKE_CURRENT_LIST_DIR}/mx_led_pwm.c>")
endif()
