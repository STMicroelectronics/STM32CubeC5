...
int main(void)
{
  /** System Init: this generated code placed in targets folder initializes your system.
    ...
    * you have configured with STM32CubeMX, if you decided to generate and call this
    * code at startup.
  ...
  else
  {
    /** Example execution: this hardware and IDE agnostic code contains the scenario we demonstrate in this example.
      ...
      * while you might keep on generating the initialization and configuration code with MX.
      */
    ExecStatus = app_init();
