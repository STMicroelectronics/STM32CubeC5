...
__Step 1__: Turns on, then off, the MX_STATUS_LED using the ``led_on`` and ``led_off`` LED part functions

__Step 2__: Toggles twice the MX_STATUS_LED using the ``led_toggle`` LED part function

__End of example__: The steps 1 and 2 are repeated infinitely.
