...
system_status_t mx_cortex_mpu_init(void)
{
  ...
  */
  ...
  HAL_CORTEX_MPU_SetCacheMemAttr(HAL_CORTEX_MPU_MEM_ATTR_2, HAL_CORTEX_MPU_NORMAL_MEM_NCACHEABLE);
  ...
  */
  ...
  p_region_config.base_addr = 0x20000000;
  p_region_config.limit_addr = 0x200020FF;
  ...
  p_region_config.base_addr = 0x40013000;
  p_region_config.limit_addr = 0x400133FF;
  p_region_config.access_attr = HAL_CORTEX_MPU_REGION_ALL_RW;
  p_region_config.exec_attr = HAL_CORTEX_MPU_EXECUTION_ATTR_DISABLE;
  p_region_config.attr_idx = HAL_CORTEX_MPU_MEM_ATTR_2;
  HAL_CORTEX_MPU_SetConfigRegion(HAL_CORTEX_MPU_REGION_2, &p_region_config);

  HAL_CORTEX_MPU_EnableRegion(HAL_CORTEX_MPU_REGION_2);
