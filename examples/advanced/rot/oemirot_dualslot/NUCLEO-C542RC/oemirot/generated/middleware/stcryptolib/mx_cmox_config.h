...
/**
  * @brief Flag indicating the implementation of AES.
  */
...
/**
  * @brief Flag indicating the implementation of GCM.
  */
...
/**
  * @brief Flag indicating the implementation for RSA low level mathematical functions.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for ECC 256 bits curves
...
/**
  * @brief Flag indicating the implementation for ECC 128 bits multiple curves
  *        low level mathematical functions.
  * @note  Value can be
  *        - @ref CMOX_MATH_FUNCS_SMALL
  *        - @ref CMOX_MATH_FUNCS_FAST
...
/**
  * @brief Flag indicating the implementation for ECC curves not defined by the above
  *        low level mathematical functions.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for EDWARDS Ed25519 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for EDWARDS Ed448 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for NIST-R P-224 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for NIST-R P-256 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for NIST-R P-384 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for NIST-R P-521 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for NIST-K P-256 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-160 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-192 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-224 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-256 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-320 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-384 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-R P-512 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-160 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-192 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-224 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-256 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-320 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-384 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for BRAINPOOL-T P-512 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for ANSSI P-256 ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for OSCCA 256 bit ECC curves.
  * @note  Value can be
...
/**
  * @brief Flag indicating the implementation for OSCCA 256 bit test ECC curves.
  * @note  Value can be
