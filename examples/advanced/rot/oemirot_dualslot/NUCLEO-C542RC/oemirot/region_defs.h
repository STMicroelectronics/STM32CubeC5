...
*/
#define SRAM_ROT_BASE                       (0x20008000U)
#define SRAM_ROT_SIZE                       (0x00005000U)
/* SRAM usable at start of appli: SRAM1/2 */
#define SRAM_BASE                           (0x20000000U) /* SRAM1 base address */
#define SRAM_SIZE                           (0x00010000U) /* contiguous SRAM size from SRAM1 */
...
/* MPU RO and system memory region (for access to EXITHDPLIB function pointers and device memory size) */
