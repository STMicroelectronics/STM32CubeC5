...
/** @defgroup HAL_PLAY_Config HAL PLAY Configuration
  * @{
  */
/* ########################## HAL_PLAY Config ################################### */
#define USE_HAL_PLAY_MODULE                     0U
#define USE_HAL_PLAY_CLK_ENABLE_MODEL           HAL_CLK_ENABLE_NO
#define USE_HAL_PLAY_REGISTER_CALLBACKS         0U
#define USE_HAL_PLAY_USER_DATA                  0U
/**
  * @}
  */
