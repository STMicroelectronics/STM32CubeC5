/**
  ******************************************************************************
  * @file    startup_stm32c562xx.c
  * @brief   Startup File for STM32C562xx Devices
  ******************************************************************************
  * @attention
  *
...
#ifdef __cplusplus
#error "startup_stm32c562xx.c file cannot be compiled with C++ compiler"
#endif /* __cplusplus */
...
__NO_RETURN void Default_IRQHandler(void);
...
void LPDMA1_CH4_IRQHandler            (void) __attribute__((weak, alias("Default_IRQHandler")));
void LPDMA1_CH5_IRQHandler            (void) __attribute__((weak, alias("Default_IRQHandler")));
void LPDMA1_CH6_IRQHandler            (void) __attribute__((weak, alias("Default_IRQHandler")));
void LPDMA1_CH7_IRQHandler            (void) __attribute__((weak, alias("Default_IRQHandler")));
...
const VECTOR_TABLE_Type __VECTOR_TABLE[] __VECTOR_TABLE_ATTRIBUTE =
{
  ...
  LPDMA1_CH4_IRQHandler,
  LPDMA1_CH5_IRQHandler,
  LPDMA1_CH6_IRQHandler,
  LPDMA1_CH7_IRQHandler,
  IWDG_IRQHandler,
  ADC1_IRQHandler,
  ADC2_IRQHandler,
...
/**
  ...
  *         could be overriden by the application.
  * @param  None
  * @retval None
  */
