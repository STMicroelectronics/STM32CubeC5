...
#define FLASH_PRIMARY_APP_SLOT_SIZE                       (0x14000U)

/* App image secondary slot offset */
#define FLASH_SECONDARY_APP_SLOT_OFFSET                   (0x2C000U)

/* App image secondary slot size */
#define FLASH_SECONDARY_APP_SLOT_SIZE                     (0x14000U)

/* Data image secondary slot offset */
#define FLASH_SECONDARY_DATA_SLOT_OFFSET                  (0x40000U)
...
#define FLASH_SECONDARY_APP_INSTALL_REQ_OFFSET            (0x3FFF0U)
...
#define FLASH_PRIMARY_APP_CONFIRM_OFFSET                  (0x2BFE0U)
