...
How to manage a full-duplex synchronous SPI communication as responder, in DMA mode, using the LL API.
...
__Step 1__: configures and initializes the SPI instance in DMA mode.
...
- ll_spi_full_duplex_two_boards_com_dma_controller: full duplex synchronous SPI communication of the controller with the responder, in DMA mode.
