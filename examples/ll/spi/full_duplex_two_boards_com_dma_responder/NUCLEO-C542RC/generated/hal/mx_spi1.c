...
SPI_TypeDef *mx_spi1_init(void)
{
  ...
  uint32_t cfg1_config = LL_SPI_DATA_WIDTH_8_BIT | LL_SPI_BAUD_RATE_PRESCALER_2;
  uint32_t cfg2_config = LL_SPI_MODE_SLAVE | LL_SPI_FULL_DUPLEX | LL_SPI_CLOCK_POLARITY_LOW
