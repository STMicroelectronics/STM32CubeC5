...
USART_TypeDef *mx_usart3_usart_init(void)
{
  ...
  /* LL_RCC_SetUSARTClockSource(LL_RCC_USART3_CLKSOURCE_PCLK1); */ /* Configuration matches register reset state at startup. */

  LL_USART_ConfigSyncMasterMode(USART3);

  LL_USART_ConfigXfer(USART3, LL_USART_DATAWIDTH_8_BIT | LL_USART_PARITY_NONE
  ...
  /* LL_USART_SetPrescaler(USART3, LL_USART_PRESCALER_DIV1); */ /* Configuration matches register reset state at startup. */
