...
/**
  * @brief  Initialize the mx_usart3_usart with LL layer
  *         Name of the User label:
  *                   MX_USARTx
  * @retval USART3 Pointer on the USART3
  */
#define mx_usartx_init mx_usart3_usart_init
...
/**
  * @brief  De-Initialize the mx_usart3_usart with LL layer
  *         Name of the User label:
  *                   MX_USARTx
  */
#define mx_usartx_deinit mx_usart3_usart_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    ...
    Alias on USART3_IRQHandler and USART3_IRQn
    ************************************************************* */
#define mx_usartx_irqhandler USART3_IRQHandler
#define MX_USARTX_IRQN       USART3_IRQn

  /* *************************************************************
    USART3 / LPDMA1_CH0: LPDMA1 channel0 global interrupt
...
#define MX_LPDMAX_CH1Y_IRQN       LPDMA1_CH0_IRQn
  ...
  /* *************************************************************
    USART3 / LPDMA1_CH1: LPDMA1 channel1 global interrupt
