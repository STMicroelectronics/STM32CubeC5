...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      I2C1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_i2c1_i2c with LL layer
  *         Name of the User label:
  *                   MX_I2Cx
  * @retval I2C1 Pointer on the I2C1
  */
#define mx_i2cx_init mx_i2c1_i2c_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      I2C1: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_i2c1_i2c with LL layer
  *         Name of the User label:
  *                   MX_I2Cx
  */
#define mx_i2cx_deinit mx_i2c1_i2c_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    I2C1: I2C1 event interrupt
    Alias on I2C1_EV_IRQHandler and I2C1_EV_IRQn
    ************************************************************* */
#define mx_i2cx_ev_irqhandler I2C1_EV_IRQHandler
#define MX_I2CX_EV_IRQN       I2C1_EV_IRQn

  /* *************************************************************
    I2C1: I2C1 error interrupt
    Alias on I2C1_ERR_IRQHandler and I2C1_ERR_IRQn
    ************************************************************* */
#define mx_i2cx_err_irqhandler I2C1_ERR_IRQHandler
#define MX_I2CX_ERR_IRQN       I2C1_ERR_IRQn
