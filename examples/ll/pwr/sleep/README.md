...
<!--
@startditaa doc/STMicroelectronics.example_ll_pwr_sleep-setup.png
  /--------------------\
  |                    |
  |       /------------+
  |       |    GPIO    |
...
![STMicroelectronics](doc/STMicroelectronics.example_ll_pwr_sleep-setup.png)
