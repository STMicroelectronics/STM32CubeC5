...
# __Example: *ll_pwr_standby*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to enter and exit the Standby mode through a wake-up pin using the LL API.
...
<!--
@startditaa doc/STMicroelectronics.example_ll_pwr_standby-setup.png
  /--------------------\
  |                    |
  |       /------------+
  |       |    GPIO    |
...
![STMicroelectronics](doc/STMicroelectronics.example_ll_pwr_standby-setup.png)
...
__Standby system checks__: It is possible to check if the system was in Standby mode using the LL_PWR_IsActiveFlag_SB() function. And it is possible to check if a Standby mode reset is generated using the LL_RCC_IsActiveFlag_LPWRRST() function.
