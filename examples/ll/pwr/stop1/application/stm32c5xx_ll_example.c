...
/** brief: Enter the Stop1 mode request.
  */
inline void PWR_EnterStop1Mode(void)
{
...
/** brief:  Check if the system has resumed from Stop1 mode.
  * retval: system_status_t
  */
inline system_status_t PWR_CheckSystemStop1Mode(void)
{
  system_status_t system_status = SYSTEM_PERIPHERAL_ERROR;

  /* Check that the system has resumed from Stop1 mode */
