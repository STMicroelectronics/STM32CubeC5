...
# __Example: *ll_pwr_stop1*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to enter and exit the Stop1 mode through an EXTI interrupt using the LL API.
...
<!--
@startditaa doc/STMicroelectronics.example_ll_pwr_stop1-setup.png
  /--------------------\
  |                    |
  |       /------------+
  |       |    GPIO    |
...
![STMicroelectronics](doc/STMicroelectronics.example_ll_pwr_stop1-setup.png)
