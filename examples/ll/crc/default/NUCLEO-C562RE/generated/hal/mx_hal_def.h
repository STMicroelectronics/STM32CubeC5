...
/**
  * @brief  Initialize the mx_crc with LL layer
  *         Name of the User label:
  *                   MX_CRCx
  * @retval CRC Pointer on the CRC
  */
#define mx_crcx_init mx_crc_init
...
/**
  * @brief  De-Initialize the mx_crc with LL layer
  *         Name of the User label:
  *                   MX_CRCx
  */
#define mx_crcx_deinit mx_crc_deinit
