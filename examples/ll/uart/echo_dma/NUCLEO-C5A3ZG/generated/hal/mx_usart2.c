...
USART_TypeDef *mx_usart2_uart_init(void)
{
  ...
  /* LL_GPIO_SetPinSpeed(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_SPEED_FREQ_LOW); */ /* Configuration matches register reset state at startup. */
  /* LL_GPIO_SetPinSpeed(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_SPEED_FREQ_LOW); */ /* Configuration matches register reset state at startup. */

  /* Configure IO output type (Push-Pull or Open-Drain) */
  /* LL_GPIO_SetPinOutputType(GPIOA, DBGIN_VCP_RX_PIN | DBGIN_VCP_TX_PIN, LL_GPIO_OUTPUT_PUSHPULL); */ /* Configuration matches register reset state at startup. */

  /* Activate the Pull-up, Pull-down resistor, or No pull for the current IO */
  /* LL_GPIO_SetPinPull(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_PULL_NO); */ /* Configuration matches register reset state at startup. */
  /* LL_GPIO_SetPinPull(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_PULL_NO); */ /* Configuration matches register reset state at startup. */

  /* Configure the Alternate Function in current IO */
  LL_GPIO_SetAFPin_0_7(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_AF_7);
  LL_GPIO_SetAFPin_0_7(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_AF_7);

  /* Configure IO direction mode (Input, Output, Alternate or Analog) */
  LL_GPIO_SetPinMode(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_MODE_ALTERNATE);
  LL_GPIO_SetPinMode(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_MODE_ALTERNATE);
  ...
  /* Configure DMA channel priority level */
  LL_DMA_SetChannelPriorityLevel(LPDMA1_CH1, LL_DMA_PRIORITY_HIGH);
...
void mx_usart2_uart_deinit(void)
{
  ...
  LL_GPIO_SetPinMode(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_MODE_ANALOG);
  LL_GPIO_SetPinMode(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_MODE_ANALOG);

  /* Configure the default Alternate Function in current IO */
  LL_GPIO_SetAFPin_0_7(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_AF_0);
  LL_GPIO_SetAFPin_0_7(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_AF_0);

  /* Configure the default value for IO Speed */
  LL_GPIO_SetPinSpeed(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_SPEED_FREQ_LOW);
  LL_GPIO_SetPinSpeed(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_SPEED_FREQ_LOW);

  /* Configure the default value IO Output Type */
  LL_GPIO_SetPinOutputType(GPIOA, DBGIN_VCP_RX_PIN | DBGIN_VCP_TX_PIN, LL_GPIO_OUTPUT_PUSHPULL);

  /* Deactivate the Pull-up and Pull-down resistor for the current IO */
  LL_GPIO_SetPinPull(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN, LL_GPIO_PULL_NO);
  LL_GPIO_SetPinPull(DBGIN_VCP_TX_PORT, DBGIN_VCP_TX_PIN, LL_GPIO_PULL_NO);

  /* Reset the IO output state */
  LL_GPIO_WriteOutputPin(DBGIN_VCP_RX_PORT, DBGIN_VCP_RX_PIN | DBGIN_VCP_TX_PIN, LL_GPIO_PIN_RESET);
