...
*** Settings ***
Documentation       Automatic test for example_ll_i3c_private_it_controller.
...
Example Step 2
    ...
    Sleep    3s    # Wait for the DAA process to complete, as there is no console output to check this step
