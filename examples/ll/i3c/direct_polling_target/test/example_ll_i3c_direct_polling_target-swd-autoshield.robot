...
*** Settings ***
Documentation       Automatic test for example_ll_i3c_direct_polling_target.
...
Example Step 3
    [Documentation]    The target is expected to receive the CCC command from the controller board, in polling mode.
