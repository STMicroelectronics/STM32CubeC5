...
*** Settings ***
Documentation       Automatic test for example_hal_i3c_hotjoin_it_target.
...
${TEST_ID} Scenario adherence
    ...
    Init I3C Controller    I3C_SCL    I3C_SDA    enable_hot_join=${True}
    Comment    1 = mode Listen for Hot-Join request
    Set I3C Target Listen Mode    1
    Reset Target
    Example Step 1
    Example Step 2
...
Example Step 2
    [Documentation]    The target is expected to receive the Hot-Join request.
    Comment    Option = 1 Dynamic Address Assignment option I3C_ENTDAA_ONLY
    FOR    ${j}    IN RANGE    2
