...
*** Settings ***
Documentation       Automatic test for example_ll_i3c_ibi_target.
...
${TEST_ID} Scenario adherence
    ...
    Init I3C Controller    I3C_SCL    I3C_SDA    enable_ibi=${True}
    Reset Target
    Example Step 1
    Example Step 2
    Example Step 3
...
Example Step 2
    ...
    Comment    3 = mode Listen for IBI request
    Set I3C Target Listen Mode    3

Example Step 3
    [Documentation]    Sends IBI request from target and waits for completion.
    Get I3C Controller Info
