...
#define mx_example_rcc  RCC
  ...
  /* ***********************************************************
                Aliases to LPUART1 used in LL
    *********************************************************** */
#define MX_LPUARTx  LPUART1
...
#define mx_example_rcc_init mx_rcc_init
  ...
  /* ***********************************************************
      LPUART1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_lpuart1_uart with LL layer
  *         Name of the User label:
  *                   MX_LPUARTx
  * @retval LPUART1 Pointer on the LPUART1
  */
#define mx_lpuartx_init mx_lpuart1_uart_init
...
#define mx_gpiox_deinit mx_gpio_default_deinit
  ...
  /* ***********************************************************
      LPUART1: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_lpuart1_uart with LL layer
  *         Name of the User label:
  *                   MX_LPUARTx
  */
#define mx_lpuartx_deinit mx_lpuart1_uart_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    LPUART1: LPUART1 Rx interrupt OR LPUART1 Tx interrupt
    Alias on LPUART1_IRQHandler and LPUART1_IRQn
    ************************************************************* */
#define mx_lpuartx_irqhandler LPUART1_IRQHandler
#define MX_LPUARTX_IRQN       LPUART1_IRQn
