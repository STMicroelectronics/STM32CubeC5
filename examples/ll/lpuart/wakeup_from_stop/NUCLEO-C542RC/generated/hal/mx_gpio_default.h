...
#define PB0_INIT_STATE                                  LL_GPIO_PIN_RESET
#define PB0_ACTIVE_STATE                                LL_GPIO_PIN_SET
#define PB0_INACTIVE_STATE                              LL_GPIO_PIN_RESET

/* Secondary aliases for GPIO PB0 pin */
#define MX_STATUS_WAKEUP_PORT                           GPIOB
#define MX_STATUS_WAKEUP_PIN                            LL_GPIO_PIN_0
#define MX_STATUS_WAKEUP_INIT_STATE                     LL_GPIO_PIN_RESET
#define MX_STATUS_WAKEUP_ACTIVE_STATE                   LL_GPIO_PIN_SET
#define MX_STATUS_WAKEUP_INACTIVE_STATE                 LL_GPIO_PIN_RESET
