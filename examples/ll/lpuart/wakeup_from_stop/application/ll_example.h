...
/**
  * brief: Receive MX_LPUARTx data in interrupt mode.
  * param: p_data    Pointer to data buffer.
  * param: size_byte Amount of data elements to be received in bytes.
  */
void UART_Receive_IT(void *p_data, uint32_t size_byte);
...
/**
  * brief: MX_LPUARTx Tx transfer complete callback.
  */
void UART_TxTransferCpltCallback(void);

/**
  * brief: MX_LPUARTx Rx transfer complete callback.
  */
void UART_RxTransferCpltCallback(void);

#if defined(USE_LL_APP_ERROR) && (USE_LL_APP_ERROR == 1)
/**
  * brief: MX_LPUARTx error transfer callback.
  */
