...
*** Settings ***
Documentation       Automatic test for example_ll_adc_analog_watchdog.
...
Example Step 4
    ...
    Check Integer Variable    GPIO_mV    1700    1900    timeout=2s
    Write Voltage    ANALOG_PIN    1.500V
    Check Integer Variable    AnalogWatchdogStatus    0    timeout=2s
    Write Voltage    ANALOG_PIN    1.800V
    Check Integer Variable    AnalogWatchdogStatus    1    timeout=2s
    Check Integer Variable    GPIO_mV    1650    1950    timeout=2s
