...
# __Example: *ll_adc_analog_watchdog*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the ADC with an ADC analog watchdog to monitor a channel and detect when the corresponding conversion data is outside the window thresholds in interrupt mode. This example is based on the ADC LL API.
...
__Step 3__: The ADC conversion is started in continuous mode: ADC interruption enabled with analog watchdog.

__Step 4__: The ADC waits for conversion data is out of the analog watchdog window. When the analog watchdog callback is triggered, retrieves the ADC value in millivolt for GPIO conversions.
