...
How to use the ADC to convert a single channel in continuous conversion mode from a software start.This example is based on the ADC LL API.
...
__Step 4__: Retrieves the ADC value in millivolt for GPIO conversions.
