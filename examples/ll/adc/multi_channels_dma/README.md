...
The conversion is performed using the DMA programming model. This example is based on the ADC LL API.
...
__Step 4__: Computation of physical values from ADC conversion raw data.
...
For instance, debugging step by step with any register inspection view, might break the example behavior.
