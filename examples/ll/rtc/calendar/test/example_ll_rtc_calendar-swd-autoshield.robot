...
*** Settings ***
Documentation       Automatic test for example_ll_rtc_calendar.
...
${TEST_ID} Scenario adherence
    ...
    ${hms_1}=    Create List    ${time_1[3]}    ${time_1[2]}    ${time_1[1]}
    ${hms_2}=    Create List    ${time_2[3]}    ${time_2[2]}    ${time_2[1]}
...
Example Step 2
    ...
    ${time}=    struct.Unpack    ${LITTLE_ENDIAN} 4${INT32_FMT}    ${time}
