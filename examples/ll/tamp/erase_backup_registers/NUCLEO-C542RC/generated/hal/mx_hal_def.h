...
/* Exported constants --------------------------------------------------------*/
  ...
  /* *************************************************************
    RTC (LL): No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for CMSIS instance
    ************************************************************* */

  /* ***********************************************************
                Aliases to TAMP used in LL
    *********************************************************** */
#define MX_TAMPx  TAMP
...
/* ########### Aliases to initialization functions ########### */
  ...
  /* *************************************************************
    RTC: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for mx_rtc_init
    ************************************************************* */
...
/**
  * @brief  Initialize the mx_tamp with LL layer
  *         Name of the User label:
  *                   MX_TAMPx
  * @retval TAMP Pointer on the TAMP
  */
#define mx_tampx_init mx_tamp_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* *************************************************************
    RTC: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for mx_rtc_deinit
    ************************************************************* */
...
/**
  * @brief  De-Initialize the mx_tamp with LL layer
  *         Name of the User label:
  *                   MX_TAMPx
  */
#define mx_tampx_deinit mx_tamp_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    ...
    ************************************************************* */
#define mx_tampx_irqhandler TAMP_IRQHandler
#define MX_TAMPX_IRQN       TAMP_IRQn
