...
COMP_TypeDef *mx_comp1_init(void)
{
  ...
  /* LL_COMP_SetCommonWindowMode(LL_COMP_COMMON_INSTANCE(COMP1), LL_COMP_WINDOW_DISABLE); */
  /* LL_COMP_SetCommonWindowOutput(LL_COMP_COMMON_INSTANCE(COMP1), LL_COMP_WINDOW_OUTPUT_INDEPT); */
...
/******************************************************************************/
/*          COMP1 global interrupt is managed directly in user code.          */
/******************************************************************************/
