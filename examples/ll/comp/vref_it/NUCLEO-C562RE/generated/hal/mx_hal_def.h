...
/* Exported constants --------------------------------------------------------*/
  /* ***********************************************************
                Aliases to COMP1 used in LL
    *********************************************************** */
#define MX_COMPx  COMP1

  /* *************************************************************
    COMP1 / EXTI34 (LL): No software label has been defined for this peripheral instance
...
/**
  * @brief  Initialize the mx_comp1 with LL layer
  *         Name of the User label:
  *                   MX_COMPx
  * @retval COMP1 Pointer on the COMP1
  */
#define mx_compx_init mx_comp1_init
...
/**
  * @brief  De-Initialize the mx_comp1 with LL layer
  *         Name of the User label:
  *                   MX_COMPx
  */
#define mx_compx_deinit mx_comp1_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    COMP1: COMP global interrupt
    Alias on COMP1_IRQHandler and COMP1_IRQn
    ************************************************************* */
#define mx_compx_irqhandler COMP1_IRQHandler
#define MX_COMPX_IRQN       COMP1_IRQn
