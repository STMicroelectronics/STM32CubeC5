...
# __Example: *ll_opamp_standalone*__
...
This example is based on the OPAMP LL API.
...
- ll_opamp_follower: demonstrates the follower of the OPAMP.
- ll_opamp_interconnect: integrates this peripheral with DAC and ADC.
