...
ADC_TypeDef *mx_adc1_init(void)
{
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_6, LL_ADC_SAMPLINGTIME_289CYCLES);
  LL_ADC_SetChannelSingleDiff(ADC1, LL_ADC_CHANNEL_6, LL_ADC_IN_SINGLE_ENDED);
  LL_ADC_SetChannelPreselection(ADC1, LL_ADC_CHANNEL_6);
...
void mx_adc1_deinit(void)
{
  ...
  /* ### GPIO deinitialization of ADC1: ADC1_IN6 ########################### */
