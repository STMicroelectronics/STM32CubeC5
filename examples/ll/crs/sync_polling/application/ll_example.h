...
/** brief: Start the MX_CRSx synchronization
  */
void CRS_StartSynchronization(void);

/** brief:  Polling for end of synchronization and retrieve status.
  * retval SYSTEM_OK Synchronization success.
  * retval SYSTEM_PERIPHERAL_ERROR Synchronization error.
  */
system_status_t CRS_PollForSynchronization(void);
