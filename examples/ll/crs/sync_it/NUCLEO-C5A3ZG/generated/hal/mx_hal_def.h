...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      CRS: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_crs with LL layer
  *         Name of the User label:
  *                   MX_CRSx
  * @retval CRS Pointer on the CRS
  */
#define mx_crsx_init mx_crs_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      CRS: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_crs with LL layer
  *         Name of the User label:
  *                   MX_CRSx
  */
#define mx_crsx_deinit mx_crs_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    CRS: Clock Recovery System global interrupt
    Alias on CRS_IRQHandler and CRS_IRQn
    ************************************************************* */
#define mx_crsx_irqhandler CRS_IRQHandler
#define MX_CRSX_IRQN       CRS_IRQn
