...
# __Example: *ll_lptim_pwm_external_clock*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to configure the LPTIM (Low-Power Timer) and to generate a PWM signal using an external clock in low power mode with LL API.
...
__Step 1__: Initializes and starts the LPTIM instance.

__Step 2__: The device goes in Low power mode while the PWM output signal is generated depending on the external clock provided.

__End of example__: If no error occurs, the example stays in low-power mode in the *app_process()* function.
...
- The RCC is configured to keep the LPTIM internal clock active while in low-power mode.
...
@startditaa{doc/example_ll_lptim_pwm_external_clock-setup.svg}
...
![example_ll_lptim_pwm_external_clock-setup](doc/example_ll_lptim_pwm_external_clock-setup.svg)
