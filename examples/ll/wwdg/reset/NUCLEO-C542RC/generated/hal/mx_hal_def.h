...
/* Exported constants --------------------------------------------------------*/
  ...
  /* ***********************************************************
                Aliases to WWDG used in LL
    *********************************************************** */
#define MX_WWDGx  WWDG
...
/**
  * @brief  Initialize the mx_wwdg with LL layer
  *         Name of the User label:
  *                   MX_WWDGx
  * @retval WWDG Pointer on the WWDG
  */
#define mx_wwdgx_init mx_wwdg_init
...
/**
  * @brief  De-Initialize the mx_wwdg with LL layer
  *         Name of the User label:
  *                   MX_WWDGx
  */
#define mx_wwdgx_deinit mx_wwdg_deinit
