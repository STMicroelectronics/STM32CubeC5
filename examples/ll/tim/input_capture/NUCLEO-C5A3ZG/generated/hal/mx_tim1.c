...
TIM_TypeDef *mx_tim1_init(void)
{
  ...
  /* LL_TIM_SetAutoReload(TIM1, 65535); */ /* Configuration matches register reset state at startup. */
  ...
  /* LL_TIM_IC_SetSource(TIM1, LL_TIM_TIM1_TI1_GPIO); */ /* Configuration matches register reset state at startup. */
