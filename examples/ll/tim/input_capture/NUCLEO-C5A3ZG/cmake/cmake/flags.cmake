...
elseif(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C5A3ZG")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_debug_GCC_NUCLEO-C5A3ZG ../../../../../../arch/cmsis/CMSIS/Core/Include ../generated/hal ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/ll ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC MX_TIMX=TIM1 MX_TIM_PRESCALER=143 STM32C5A3xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC ${CPU_FLAGS})
endif()
