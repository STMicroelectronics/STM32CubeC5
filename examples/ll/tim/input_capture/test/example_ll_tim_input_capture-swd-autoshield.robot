...
*** Settings ***
Documentation       Automatic test for example_ll_tim_input_capture.
...
Example Step 2
    [Documentation]    Starts the timer in Input Capture mode for a single channels.
    Comment    No Check
...
Example Step 3
    [Documentation]    Measures the frequency on each rising edge of the external input signal
