...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    TIM1: TIM1 capture compare interrupt
    Alias on TIM1_CC_IRQHandler and TIM1_CC_IRQn
    ************************************************************* */
#define mx_timx_cc_irqhandler TIM1_CC_IRQHandler
#define MX_TIMX_CC_IRQN       TIM1_CC_IRQn
