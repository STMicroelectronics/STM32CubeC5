...
![tim_example_break_and_deadtime](doc/tim_example_break_and_deadtime.svg)
...
- tDTS (timer Dead Time Sampling) Calculation:
...
- tDTG (timer Dead Time Generator) Calculation:
