...
/**
  * @brief  Initialize the mx_tim1 with LL layer
  *         Name of the User label:
  *                   MX_TIMx
  * @retval TIM1 Pointer on the TIM1
  */
#define mx_timx_init mx_tim1_init
...
/**
  * @brief  De-Initialize the mx_tim1 with LL layer
  *         Name of the User label:
  *                   MX_TIMx
  */
#define mx_timx_deinit mx_tim1_deinit
...
/* ########### Aliases to get IRQ Handlers functions ########### */
  /* *************************************************************
    TIM1 / LPDMA1_CH0: LPDMA1 channel0 global interrupt
...
#define MX_LPDMAX_CHY_IRQN       LPDMA1_CH0_IRQn
  ...
  /* *******************************************************************
      TIM1 / LPDMA1_CH0: aliases for DMA lli register functions
    ******************************************************************** */
#define MX_LPDMAx_CHy_dma_get_lli_reg mx_tim1_cc1_dma_get_lli_reg
