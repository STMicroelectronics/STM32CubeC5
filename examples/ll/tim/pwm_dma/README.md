...
To obtain a timer counter clock at 1MHz with the APB prescaler set to 1 and the HCLK set to 144MHz, the timer prescaler must be:
  ...
  | :---:           | :---:     | :---:          | :---:                       | :---:        |
  | CN5-6           |    PA5    | MX_STATUS_LED  | D13                         |     PA5      |
  | CN9-8           |    PA8    | TIM1_CH1       | D7                          |     PA8      |
...
- ll_tim_pwm_output: demonstrates how to use the TIM peripheral to generate a PWM signal.
