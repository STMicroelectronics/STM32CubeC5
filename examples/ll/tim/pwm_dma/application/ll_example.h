...
/** brief: Start the MX_TIMx Output Channel in DMA mode (default DMA interrupts).
  */
void TIM_OC_StartChannel_DMA(const uint8_t *p_data, uint32_t size_byte);

/** brief: Start the MX_TIMx.
  */
void TIM_Start(void);
