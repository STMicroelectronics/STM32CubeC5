...
TIM_TypeDef *mx_tim1_init(void)
{
  ...
  LL_TIM_IC_SetSource(TIM1, LL_TIM_TIM1_TI2_GPIO);
  ...
  /* LL_GPIO_SetPinOutputType(GPIOA, LL_GPIO_PIN_9 | LL_GPIO_PIN_8, LL_GPIO_OUTPUT_PUSHPULL); */ /* Configuration matches register reset state at startup. */
...
void mx_tim1_deinit(void)
{
  ...
  LL_GPIO_SetPinOutputType(GPIOA, LL_GPIO_PIN_9 | LL_GPIO_PIN_8, LL_GPIO_OUTPUT_PUSHPULL);
  ...
  LL_GPIO_WriteOutputPin(GPIOA, LL_GPIO_PIN_9 | LL_GPIO_PIN_8, LL_GPIO_PIN_RESET);
}
