...
/** brief: Start the MX_TIMx in interrupt mode.
  */
void TIM_Start_IT(void);

/** brief: GPIO toggle pin.
  */
void GPIO_TogglePin(void);

/** brief: MX_TIMx Interrupt callback triggered by timer counter update event.
  */
void TimebaseCallback(void);
