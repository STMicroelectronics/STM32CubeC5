...
# __Example: *ll_dac_simple_conversion*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the DAC LL API to generate signals without using any trigger signal.
...
- __Step 2__: At each call, the DAC outputs the following voltage. The DAC conversion is done automatically as soon as the value for the output is set.
...
- hal_dac_simple_conversion: same example with HAL.
