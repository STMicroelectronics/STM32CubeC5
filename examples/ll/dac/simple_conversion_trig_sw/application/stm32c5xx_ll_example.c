/**
  ...
  * brief          : DAC generate signals using software trigger signal with LL API.
  ******************************************************************************
  *
...
/**
  *  Enable the MX_DACx channel software trigger conversion.
  */
inline void DAC_TrigSWConversionChannel(void)
{
  if (LL_DAC_IsTriggerSWEnabled(MX_DACx, MX_DAC_CHANNEL) != 0U)
  {
    /* Enable the selected DAC software conversion */
    LL_DAC_TrigSWConversion(MX_DACx, MX_DAC_CHANNEL);
  }
}
