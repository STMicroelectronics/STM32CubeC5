/**
  ******************************************************************************
  * file           : example.c
  * brief          : TIM asymmetric deadtime insertion with HAL API
  ******************************************************************************
  *
...
app_status_t app_process(void)
{
  ...
  /** ########## Step 2 ##########
    ...
    */
  if (HAL_TIM_OC_StartChannel(pTIM, MX_PWM_CHANNEL_CHy) != HAL_OK)
  {
    goto _app_process_exit;
  }

  if (HAL_TIM_OC_StartChannel(pTIM, MX_PWM_CHANNEL_CHyN) != HAL_OK)
  {
    goto _app_process_exit;
  }
