...
*** Settings ***
Documentation       Automatic test for example_hal_tim_pwm_dma_burst.
...
Example Step 2
    [Documentation]    Start Timer PWM generation with updated values CCR.
    Comment    Check output PWM frequency and duty cycle for channel 2,3 and 4
