...
hal_tim_handle_t *mx_tim1_init(void)
{
  ...
  /* Timer configuration to reach the output frequency at 7.111 kHz */
  ...
  HAL_GPIO_Init(HAL_GPIOA, PA8_PIN | PA10_PIN, &gpio_config);
...
void mx_tim1_deinit(void)
{
  ...
  HAL_GPIO_DeInit(HAL_GPIOA, PA8_PIN | PA10_PIN);
}
