...
hal_tim_handle_t *mx_tim1_init(void)
{
  ...
  /* Timer configuration to reach the output frequency at 7111 Hz */
  ...
  oc_compare_unit_config.mode  = HAL_TIM_OC_ASYMMETRIC_PWM2;
  ...
  oc_compare_unit_config.mode  = HAL_TIM_OC_ASYMMETRIC_PWM2;
  oc_compare_unit_config.pulse = 0x3;
  ...
  oc_compare_unit_config.mode  = HAL_TIM_OC_ASYMMETRIC_PWM2;
  oc_compare_unit_config.pulse = 0x5;
...
void mx_tim1_deinit(void)
{
  ...
  HAL_GPIO_DeInit(HAL_GPIOA, HAL_GPIO_PIN_8 | HAL_GPIO_PIN_10);
}
