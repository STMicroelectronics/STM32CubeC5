...
*** Settings ***
Documentation       Automatic test for example_hal_tim_asymmetric_pwm.
...
*** Variables ***
${DELAY_BETWEEN_CHANNELS}=      0.000078
${TIME_WINDOW}=                 0.001
...
Example Step 2
    ...
    Check Frequency    pin=MX_EXAMPLE_USER_PWM_Y_PIN    freq=4kHz    duty_cycle=0.5    precision=0.1

    Comment    Check output PWM frequency and duty cycle for channel z
    Check Frequency    pin=MX_EXAMPLE_USER_PWM_Z_PIN    freq=4kHz    duty_cycle=0.5    precision=0.1
