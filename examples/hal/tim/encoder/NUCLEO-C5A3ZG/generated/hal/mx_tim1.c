...
hal_tim_handle_t *mx_tim1_init(void)
{
  ...
  trigger_output2_config.trgo2_src  = HAL_TIM_TRGO2_OC4_RISING_FALLING;
  trigger_output2_config.postscaler = 0;
  if (HAL_TIM_SetConfigTriggerOutput2(&hTIM1, &trigger_output2_config) != HAL_OK)
  {
    return NULL;
  }
  ...
  HAL_GPIO_Init(HAL_GPIOA, HAL_GPIO_PIN_8 | HAL_GPIO_PIN_9, &gpio_config);
