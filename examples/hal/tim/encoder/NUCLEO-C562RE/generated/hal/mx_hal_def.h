...
/**
  ...
  *         Name of the User label:
  *                   mx_example_tim_encoder_interface
  * @retval hal_tim_handle_t Pointer on the handle on the TIM1 instance
  */
#define mx_example_tim_encoder_interface_init mx_tim1_init
...
/**
  ...
  *         Name of the User label:
  *                   mx_example_tim_emulator_encoder
  * @retval hal_tim_handle_t Pointer on the handle on the TIM2 instance
  */
#define mx_example_tim_emulator_encoder_init mx_tim2_init
...
/**
  ...
  *                   mx_example_tim_encoder_interface
  */
#define mx_example_tim_encoder_interface_deinit mx_tim1_deinit
...
/**
  ...
  *                   mx_example_tim_emulator_encoder
  */
#define mx_example_tim_emulator_encoder_deinit mx_tim2_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_tim_handle_t Pointer on the handle on the TIM1 instance
  */
#define mx_example_tim_encoder_interface_gethandle mx_tim1_gethandle
  ...
  * @retval hal_tim_handle_t Pointer on the handle on the TIM2 instance
  */
#define mx_example_tim_emulator_encoder_gethandle mx_tim2_gethandle
