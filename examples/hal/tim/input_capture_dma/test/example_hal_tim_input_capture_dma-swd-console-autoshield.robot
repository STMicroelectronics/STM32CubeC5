...
Example Step 1
    ...
    Comment    Check console first logs with initialization completed.
...
Example Step 2
    ...
    Comment    Check console for timer start.
    Read Console Until    [INFO] Step 2: Timer input capture started in DMA mode.
...
End Of Example
    ...
    Read Console Until    [INFO] Step 3: The measured frequency is:
