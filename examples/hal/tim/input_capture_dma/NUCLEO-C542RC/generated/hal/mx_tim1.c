...
hal_dma_direct_xfer_config_t xfer_cfg_tim1_cc1_dma;
  ...
  xfer_cfg_tim1_cc1_dma.direction       = HAL_DMA_DIRECTION_PERIPH_TO_MEMORY;
  xfer_cfg_tim1_cc1_dma.src_inc         = HAL_DMA_SRC_ADDR_FIXED;
  xfer_cfg_tim1_cc1_dma.dest_inc        = HAL_DMA_DEST_ADDR_INCREMENTED;
  ...
  if (HAL_DMA_SetConfigPeriphDirectXfer(&hLPDMA1_CH0, &xfer_cfg_tim1_cc1_dma) != HAL_OK)
  {
    return NULL;
  }
