...
static hal_dma_node_t DMA_Node_TIM1_CC1;
...
hal_tim_handle_t *mx_tim1_init(void)
{
  ...
  if (HAL_TIM_OC_EnableComparePreload(&hTIM1, HAL_TIM_OC_COMPARE_UNIT_1) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_TIM_SetCaptureCompareDMAReqSource(&hTIM1, HAL_TIM_CC_DMAREQ_CC) != HAL_OK)
  {
    return NULL;
  }
...
hal_dma_direct_xfer_config_t xfer_cfg_tim1_cc1_dma;
  xfer_cfg_tim1_cc1_dma.request         = HAL_LPDMA1_REQUEST_TIM1_CC1;
  xfer_cfg_tim1_cc1_dma.direction       = HAL_DMA_DIRECTION_MEMORY_TO_PERIPH;
  xfer_cfg_tim1_cc1_dma.src_inc         = HAL_DMA_SRC_ADDR_INCREMENTED;
  xfer_cfg_tim1_cc1_dma.dest_inc        = HAL_DMA_DEST_ADDR_FIXED;
  xfer_cfg_tim1_cc1_dma.src_data_width  = HAL_DMA_SRC_DATA_WIDTH_WORD;
  xfer_cfg_tim1_cc1_dma.dest_data_width = HAL_DMA_DEST_DATA_WIDTH_WORD;
  xfer_cfg_tim1_cc1_dma.priority        = HAL_DMA_PRIORITY_HIGH;

  if (HAL_DMA_SetConfigPeriphLinkedListCircularXfer(&hLPDMA1_CH0, &DMA_Node_TIM1_CC1, &xfer_cfg_tim1_cc1_dma) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_TIM_SetDMA(&hTIM1, HAL_TIM_DMA_ID_CC1, &hLPDMA1_CH0) != HAL_OK)
  {
    return NULL;
  }
