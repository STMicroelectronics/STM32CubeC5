...
<details>
<summary>PWM analysis mode</summary>
  ...
  ![pwm_input_mode_timing](doc/pwm_input_mode_timing.svg)
...
To obtain a timer counter clock at 1MHz with the HCLK set to 144MHz, the timer prescaler must be:
