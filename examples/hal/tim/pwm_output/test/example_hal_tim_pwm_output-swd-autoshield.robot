...
*** Settings ***
Documentation       Automatic test for example_hal_tim_pwm_output.
...
Example Step 2
    ...
    Check Frequency    pin=MX_EXAMPLE_USER_PWM_Y_PIN    freq=24kHz    duty_cycle=0.5    precision=0.1

    Comment    Check output PWM frequency and duty cycle for channel z
    Check Frequency    pin=MX_EXAMPLE_USER_PWM_Z_PIN    freq=24kHz    duty_cycle=0.375    precision=0.1
