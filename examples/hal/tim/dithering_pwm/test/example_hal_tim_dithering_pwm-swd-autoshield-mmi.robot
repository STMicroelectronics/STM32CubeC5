...
*** Settings ***
Documentation       Automatic test for example_hal_tim_dithering_pwm.
...
Test Tags           ip:hal_tim    using:mmi
...
Example Step 2
    [Documentation]    Enable dithering mode and start Timer PWM generation for both channels.
    Comment    Check output PWM frequency and duty cycle for channel y
    Pause Execution
    ...    Check that the brightness of LED1 increases smoothly in dethring mode. Explain everything in the README
