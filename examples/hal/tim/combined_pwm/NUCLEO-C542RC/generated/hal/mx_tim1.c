...
hal_tim_handle_t *mx_tim1_init(void)
{
  ...
  config.counter_mode           = HAL_TIM_COUNTER_CENTER_UP_DOWN;
  config.period                 = 0x28;
  ...
  oc_compare_unit_config.mode  = HAL_TIM_OC_PWM1;
  oc_compare_unit_config.pulse = 0xF;
  ...
  oc_compare_unit_config.mode  = HAL_TIM_OC_PWM1;
  oc_compare_unit_config.pulse = 0xA;
  ...
  if (HAL_TIM_OC_SetGroupChannel(&hTIM1, HAL_TIM_GROUP_AND_OC1REFC | HAL_TIM_GROUP_AND_OC2REFC | HAL_TIM_GROUP_AND_OC3REFC) != HAL_OK)
  {
    return NULL;
  }

  oc_compare_unit_config.mode  = HAL_TIM_OC_PWM2;
  oc_compare_unit_config.pulse = 0x2;
  if (HAL_TIM_OC_SetConfigCompareUnit(&hTIM1, HAL_TIM_OC_COMPARE_UNIT_5,
                                      &oc_compare_unit_config) != HAL_OK)
  {
    return NULL;
  }

  if (HAL_TIM_OC_EnableComparePreload(&hTIM1, HAL_TIM_OC_COMPARE_UNIT_5) != HAL_OK)
  {
    return NULL;
  }
...
void mx_tim1_deinit(void)
{
  ...
  HAL_GPIO_DeInit(HAL_GPIOA, PA8_PIN | PA9_PIN | PA10_PIN);
}
