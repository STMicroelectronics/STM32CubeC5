...
# __Example: *hal_tim_input_capture*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to configure the TIM peripheral in input capture mode to measure the frequency of an external signal.
...
__Step 2__: Starts the timer in input capture mode for the channel.

__Step 3__: The input capture callback computes the frequency by measuring the time between two successive rising edges of the external input signal.

__Step 4__:  Logs the value of the frequency of the external signal (if `USE_TRACE` is enabled).
