...
/**
  * @brief  Initialize the mx_usart2_usart with HAL layer
  *         Name of the User label:
  *                   mx_example_usart
  * @retval hal_usart_handle_t Pointer on the handle on the USART2 instance
  */
#define mx_example_usart_init mx_usart2_usart_init
...
/**
  * @brief  De-Initialize the mx_usart2_usart with HAL layer
  *         Name of the User label:
  *                   mx_example_usart
  */
#define mx_example_usart_deinit mx_usart2_usart_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_usart_handle_t Pointer on the handle on the USART2 instance
  */
#define mx_example_usart_gethandle mx_usart2_usart_gethandle
