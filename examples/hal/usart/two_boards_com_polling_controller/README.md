...
# __Example: *hal_usart_two_boards_com_polling_controller*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to handle an infinite number of transmit-receive transactions between two boards based on the USART-bus protocol with the HAL API, in polling mode.
...
__Step 2__: The controller starts the communication, in blocking mode, by sending a message to the responder within a specific timeout period. A counter of attempts is reset when initiating the communication loop.
...
__Step 4__: The controller checks that the sent and received buffers match.
            It returns to step 2 indefinitely if no error occurs.
...
![usart-two-boards-com-polling_NominalCase](doc/usart-two-boards-com-polling_NominalCase.svg)

<details>
<summary> Expand this tab to visualize the sequence chart diagram in case of a data transmission error. </summary>

![usart-two-boards-com-polling_AttemptsMechanism](doc/usart-two-boards-com-polling_AttemptsMechanism.svg)
...
- The clock polarity is set to LOW.
- The clock phase is set to 1_EDGE.
- The clock last bit is ENABLED.
...
You can also refer to these examples to go further with the USART peripheral:

- hal_usart_two_boards_com_polling_responder: The responder side in a polling mode USART communication driven by the controller.
