...
#define mx_gpio_status_led_init mx_gpio_default_init
  ...
  /* ***********************************************************
      IWDG: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_iwdg with HAL layer
  *         Name of the User label:
  *                   mx_example_iwdg
  * @retval hal_iwdg_handle_t Pointer on the handle on the IWDG instance
  */
#define mx_example_iwdg_init mx_iwdg_init
...
#define mx_gpio_status_led_deinit mx_gpio_default_deinit
  ...
  /* ***********************************************************
      IWDG: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_iwdg with HAL layer
  *         Name of the User label:
  *                   mx_example_iwdg
  */
#define mx_example_iwdg_deinit mx_iwdg_deinit
...
#define mx_example_flash_gethandle mx_flash_gethandle
  ...
  /* ***********************************************************
      IWDG: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for IWDG
  *         Name of the User label:
  *                   mx_example_iwdg
  * @retval hal_iwdg_handle_t Pointer on the handle on the IWDG instance
  */
#define mx_example_iwdg_gethandle mx_iwdg_gethandle
