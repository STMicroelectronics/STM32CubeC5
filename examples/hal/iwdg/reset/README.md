...
# __Example: *hal_iwdg_reset*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the IWDG HAL API to refresh the watchdog and let it reset the MCU on purpose.
...
__Step 3__: The watchdog is not refreshed on purpose to trigger the IWDG reset.
