...
Example Step 4
    ...
    # Due to STM32CubeProgrammer low speed, the check of ExecStatus is limited to its last value
    ...
    # duration should be bigger than the delay the device takes to restart: 3 x 800ms = 2400ms
