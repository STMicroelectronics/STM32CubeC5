...
#define mx_gpio_status_led_init mx_gpio_default_init
  ...
  /* ***********************************************************
      WWDG: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_wwdg with HAL layer
  *         Name of the User label:
  *                   mx_example_wwdg
  * @retval hal_wwdg_handle_t Pointer on the handle on the WWDG instance
  */
#define mx_example_wwdg_init mx_wwdg_init
...
#define mx_gpio_status_led_deinit mx_gpio_default_deinit
  ...
  /* ***********************************************************
      WWDG: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_wwdg with HAL layer
  *         Name of the User label:
  *                   mx_example_wwdg
  */
#define mx_example_wwdg_deinit mx_wwdg_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      WWDG: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for WWDG
  *         Name of the User label:
  *                   mx_example_wwdg
  * @retval hal_wwdg_handle_t Pointer on the handle on the WWDG instance
  */
#define mx_example_wwdg_gethandle mx_wwdg_gethandle
