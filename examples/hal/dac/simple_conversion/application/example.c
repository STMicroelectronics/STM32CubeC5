/**
  ******************************************************************************
  * file           : example.c
  * brief          : DAC constant signal generation without using any trigger
...
/** ########## Step 2 ##########
  ...
  * The DAC conversion is automatically done by setting a new value as output voltage of the DAC.
  */
