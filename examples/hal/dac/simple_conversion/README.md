...
# __Example: *hal_dac_simple_conversion*__
...
How to use the DAC HAL API to generate signals without using any trigger.
...
- __Step 1__: The DAC is initialized.
- __Step 2__: The DAC outputs a different voltage at each call. The DAC conversion is done automatically as soon as the value
for the output is set.
...
- DAC: one output of the DAC is configured as below:
  - No hardware trigger selected
