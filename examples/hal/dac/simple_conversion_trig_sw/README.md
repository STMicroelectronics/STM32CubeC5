...
# __Example: *hal_dac_simple_conversion_trig_sw*__
...
How to use the DAC HAL API to generate signals using the software trigger feature.
...
__Step 1__: `app_init()` Initializes the DAC.

__Step 2__: The DAC outputs a different voltage at each call. The DAC conversion is triggered by using
the software trigger feature.
              The __Step 2__ is executed indefinitely if no error occurs.
...
[INFO] Step 2: DAC output voltage set to 0 mV.
[INFO] Step 2: DAC output voltage set to 1100 mV.
[INFO] Step 2: DAC output voltage set to 2200 mV.
[INFO] Step 2: DAC output voltage set to 3300 mV.
[INFO] Step 2: DAC output voltage set to 0 mV.
...
```
