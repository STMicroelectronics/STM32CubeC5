...
hal_dac_handle_t *mx_dac1_init(void)
{
  ...
  if (HAL_RCC_DAC1_SetSampleHoldClkSource(HAL_RCC_DAC1_SH_CLK_SRC_LSI) != HAL_OK)
  {
    return NULL;
  }
  ...
  hal_dac_channel_sample_and_hold_config_t dac_channel1_sample_and_hold_config;
  dac_channel1_sample_and_hold_config.sample_time_cycle  = 386U;
  dac_channel1_sample_and_hold_config.hold_time_cycle    = 707U;
  dac_channel1_sample_and_hold_config.refresh_time_cycle = 89U;
  if (HAL_DAC_SetConfigChannelSampleAndHold(&hDAC1,
                                            HAL_DAC_CHANNEL_1,
                                            &dac_channel1_sample_and_hold_config) != HAL_OK)
  {
    return NULL;
  }

  if (HAL_DAC_EnableChannelSampleAndHold(&hDAC1,
