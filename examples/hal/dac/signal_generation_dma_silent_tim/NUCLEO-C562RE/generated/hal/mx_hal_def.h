...
/* Exported constants --------------------------------------------------------*/
  ...
  /* *************************************************************
    DAC1_CH1 / LPDMA1_CH0: No software label has been defined for this peripheral instance
...
/**
  * @brief  Initialize the mx_dac1 with HAL layer
  *         Name of the User label:
  *                   mx_example_dac
  * @retval hal_dac_handle_t Pointer on the handle on the DAC1 instance
  */
#define mx_example_dac_init mx_dac1_init
...
/**
  * @brief  Initialize the mx_tim6 with HAL layer
  *         Name of the User label:
  *                   mx_example_tim
  * @retval hal_tim_handle_t Pointer on the handle on the TIM6 instance
  */
#define mx_example_tim_init mx_tim6_init
...
/**
  * @brief  De-Initialize the mx_dac1 with HAL layer
  *         Name of the User label:
  *                   mx_example_dac
  */
#define mx_example_dac_deinit mx_dac1_deinit
...
/**
  * @brief  De-Initialize the mx_tim6 with HAL layer
  *         Name of the User label:
  *                   mx_example_tim
  */
#define mx_example_tim_deinit mx_tim6_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      DAC1: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for DAC1
  *         Name of the User label:
  *                   mx_example_dac
  * @retval hal_dac_handle_t Pointer on the handle on the DAC1 instance
  */
#define mx_example_dac_gethandle mx_dac1_gethandle
  ...
  /* ***********************************************************
      TIM6: aliases for get handle functions
    *********************************************************** *//**
  ...
  * @retval hal_tim_handle_t Pointer on the handle on the TIM6 instance
  */
#define mx_example_tim_gethandle mx_tim6_gethandle
