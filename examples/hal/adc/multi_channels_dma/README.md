...
# __Example: *hal_adc_multi_channels_dma*__
...
The conversion is performed using the DMA programming model. This example is based on the ADC HAL API.
...
__Step 1__: The ADC is configured to convert three channels, in single conversion mode, from software trigger.
...
__Step 3__: The ADC conversion is started in DMA mode.  ADC conversion data of each sequence rank is transferred by DMA into the array "AdcRawData".
Prints the ADC raw value.

__Step 4__: Computation of physical values from ADC conversion raw data. Prints the ADC computed corresponding voltage and temperature.
...
[INFO] Step 4: ADC conversion DONE.  Raw ADC value gpio = 0xfff  Raw ADC value vref = 0x5d7  Raw ADC value temperature = 0x3a8  
[INFO] Step 4: ADC conversion DONE.  Voltage  gpio value = 3313 mV Voltage vref value = 1209 temperature value = 26 Degree Celsius
[INFO] Step 3: ADC conversion started.
[INFO] Step 4: ADC conversion DONE.  Raw ADC value gpio = 0x0  Raw ADC value vref = 0x5d8  Raw ADC value temperature = 0x3a9  
[INFO] Step 4: ADC conversion DONE.  Voltage  gpio value = 0 mV Voltage vref value = 1209 temperature value = 27 Degree Celsius   
...
```
...
- ADC group regular  is configured to convert 3 channels: 1 channel from GPIO, 2 internal channels: internal voltage reference VrefInt and temperature sensor.
