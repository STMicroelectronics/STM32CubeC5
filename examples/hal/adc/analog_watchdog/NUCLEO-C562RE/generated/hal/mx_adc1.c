...
/* ==================== Group Regular ====================*/
  ...
  /* Common configuration for AWD1 */
  adc_awd_config.threshold_high = 2047;
  adc_awd_config.threshold_low  = 0;
  adc_awd_config.filtering      = HAL_ADC_AWD_FILTERING_NONE;

  adc_awd_config.group          = HAL_ADC_GROUP_REGULAR;
