...
Example Step 5
    ...
    ${adc_Secondary1}=    Get From List    ${unpacked_data}    1
    ${adc_Secondary2}=    Get From List    ${unpacked_data}    2
    Should Be True    ${adc_Secondary0} >= 3200    and ${adc_Secondary0} < 3340
    Should Be True    ${adc_Secondary1} >= 3200 and ${adc_Secondary1} < 3340
    Should Be True    ${adc_Secondary2} >= 3200 and ${adc_Secondary2} < 3340
