...
- [Application Note AN2834](https://www.st.com/resource/en/application_note/cd00211314-how-to-optimize-the-adc-accuracy-in-the-stm32-mcus-stmicroelectronics.pdf): How to get the best ADC accuracy in STM32 microcontrollers

- [Application Note AN3116](https://www.st.com/resource/en/application_note/an3116-stm32s-adc-modes-and-their-applications-stmicroelectronics.pdf): STM32's ADC modes and their applications
...
- [Application Note AN5346](https://www.st.com/resource/en/application_note/an5346-stm32g4-adc-use-tips-and-recommendations-stmicroelectronics.pdf): STM32G4 ADC use tips and recommendations

- [Application Note AN2668](https://www.st.com/resource/en/application_note/an2668-improving-stm32f1-series-stm32f3-series-and-stm32lx-series-adc-resolution-by-oversampling-stmicroelectronics.pdf): Improving STM32F1 series, STM32F3 series and STM32Lx series
 ADC resolution by oversampling

- [Application Note AN4073](https://www.st.com/resource/en/application_note/an4073-how-to-improve-adc-accuracy-when-using-stm32f2xx-and-stm32f4xx-microcontrollers-stmicroelectronics.pdf): How to improve ADC accuracy when using STM32F2xx and STM32F4xx microcontrollers

- [Application Note AN4629](https://www.st.com/resource/en/application_note/an4629-adc-hardware-oversampling-for-microcontrollers-of-the-stm32-l0-and-l4-series-stmicroelectronics.pdf): ADC hardware oversampling for microcontrollers of the STM32L0 and L4 series

- [Application Note AN5354](https://www.st.com/resource/en/application_note/an5354-getting-started-with-the-stm32h7-series-mcu-16bit-adc-stmicroelectronics.pdf): Getting started with the STM32H7 series MCU 16-bit ADC

- [Training](https://www.st.com/resource/en/product_training/stm32l4_analog_adc.pdf): STM32L4-Analog-ADC(ADC)

- [Training](https://www.st.com/resource/en/product_training/stm32f7_analog_adc.pdf): STM32F7_Analog_ADC
