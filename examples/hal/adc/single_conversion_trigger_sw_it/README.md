...
# __Example: *hal_adc_single_conversion_trigger_sw_it*__
...
The conversion is performed using the interrupt programming model. This example is based on the ADC HAL API.
...
__Step 4__: Waits for End Of Conversion (EOC): conversion complete callback. Retrieves the ADC raw value, and computes
the corresponding voltage. Prints the ADC raw value and the computed corresponding voltage. Then returns to __Step 3__
