...
Example Step 3
    ...
    Comment    Check ADC regular is started without error
    Read Console Until    [INFO] Step 3: ADC start regular conversion COMPLETED.

Example Step 4
    [Documentation]    The ADC conversion is started in it mode for injected channels.
    Comment    Check ADC injected is started without error
    Read Console Until    [INFO] Step 4: ADC start injected conversion COMPLETED.
...
Example Step 5
    ...
    Read Console Until    [INFO] Step 5: ADC conversion DONE.
