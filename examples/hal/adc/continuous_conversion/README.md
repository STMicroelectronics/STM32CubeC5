...
# __Example: *hal_adc_continuous_conversion*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the ADC to convert a single channel in continuous conversion mode from a software start.
...
__Step 1__: The ADC is configured to convert a single channel, in continuous conversion mode, from software trigger.
...
__Step 3__: The ADC conversion is started in polling mode and uses continuous conversion mode to allow for automatic, uninterrupted analog-to-digital conversions without the need
for repeated manual triggers.

__Step 4__: Retrieves the ADC raw value, and computes the corresponding voltage. Prints the ADC raw value and the computed corresponding voltage.

__End of example__: The ADC conversion is repeated every second endlessly (step 4 is running in a loop).
...
[INFO] Step 4: ADC conversion DONE.  Raw ADC value = 0x1eb   Voltage = 395 mV
[INFO] Step 4: ADC conversion DONE.  Raw ADC value = 0x1c0   Voltage = 361 mV
...
```
