...
/**
  ...
  * @retval system_status_t Value based on the system_status_t
  */
#define mx_example_pvd_irq_init mx_pwr_init
...
/**
  ...
  *                   mx_example_pvd_irq
  */
#define mx_example_pvd_irq_deinit mx_pwr_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      PWR/EXTI: aliases for EXTI get handle functions
    *********************************************************** */

/**
  * @brief  Get the EXTI handle for EXTI16 used for PWR
  * @retval hal_exti_handle_t Pointer on the handle on the EXTI16 used by PWR instance
  */
#define mx_example_pvd_irq_gethandle mx_pwr_exti16_gethandle
