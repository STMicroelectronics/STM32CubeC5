/**
  ******************************************************************************
  * file           : example.c
  * brief          : Enter and exit the Stop0 mode through an EXTI interrupt using the HAL API
  ******************************************************************************
  *
...
app_status_t app_process(void)
{
  ...
  HAL_PWR_EnterStopMode(HAL_PWR_LOW_PWR_MODE_WFI, HAL_PWR_STOP0_MODE);

  /* Execution resumes here when the MCU wakes up */
  if (HAL_PWR_GetPreviousSystemPowerMode() != HAL_PWR_SYSTEM_STOP0_MODE)
  {
