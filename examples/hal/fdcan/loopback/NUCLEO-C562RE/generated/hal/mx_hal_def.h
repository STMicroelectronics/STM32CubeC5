...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      FDCAN1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_fdcan1 with HAL layer
  *         Name of the User label:
  *                   mx_example_fdcan
  * @retval hal_fdcan_handle_t Pointer on the handle on the FDCAN1 instance
  */
#define mx_example_fdcan_init mx_fdcan1_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      FDCAN1: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_fdcan1 with HAL layer
  *         Name of the User label:
  *                   mx_example_fdcan
  */
#define mx_example_fdcan_deinit mx_fdcan1_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      FDCAN1: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for FDCAN1
  *         Name of the User label:
  *                   mx_example_fdcan
  * @retval hal_fdcan_handle_t Pointer on the handle on the FDCAN1 instance
  */
#define mx_example_fdcan_gethandle mx_fdcan1_gethandle
