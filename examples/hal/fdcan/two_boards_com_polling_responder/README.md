...
# __Example: *hal_fdcan_two_boards_com_polling_responder*__
...
__Step 2__: starts the communication and expects to receive a filtered message in blocking mode, within a specific timeout period. A counter of attempts is reset when initiating the communication loop.

__Step 3__: sends back the message to the controller, in blocking mode and continues to __Step2__ if no error occurs.
...
<!--
@startditaa{doc/example_hal_fdcan_two_boards_com_polling_responder-setup.png} -E -S
    /-------------------------\                                                /-------------------------\
    |          /--------------+       FDCAN                        FDCAN       +--------------\          |
...
![example_hal_fdcan_two_boards_com_polling_responder-setup](doc/example_hal_fdcan_two_boards_com_polling_responder-setup.png)
