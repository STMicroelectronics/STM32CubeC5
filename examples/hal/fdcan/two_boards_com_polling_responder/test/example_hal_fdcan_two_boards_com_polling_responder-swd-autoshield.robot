...
*** Settings ***
Documentation       Automatic test for example_hal_fdcan_two_boards_com_polling_responder.
...
Example Step 2
    [Documentation]    The responder expects to receive the FDCAN message in polling mode with correct ID.
...
Example Step 3
    [Documentation]    The responder transmits in polling mode a FDCAN message with the correct ID.
