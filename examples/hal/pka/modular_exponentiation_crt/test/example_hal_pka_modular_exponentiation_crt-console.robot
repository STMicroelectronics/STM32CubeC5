...
*** Settings ***
Documentation       Automatic test for example_hal_pka_modular_exponentiation_crt.
...
Example Step 2
    [Documentation]    Perform decryption using the Chinese Remainder Theorem (CRT) optimization with the RSA.

    Read Console Until    [INFO] Step 2.1: PKA configuration to process RSA CRT exponentiation operation COMPLETED.
    Read Console Until    [INFO] Step 2.2: Decipher ciphertext using PKA modular exponentiation COMPLETED.
