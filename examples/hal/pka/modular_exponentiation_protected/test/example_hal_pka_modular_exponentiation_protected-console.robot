...
*** Settings ***
Documentation       Automatic test for example_hal_pka_modular_exponentiation_protected.
...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2.2: Computes (A^e mod n) using PKA protected modular exponentiation COMPLETED.
