...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2: Memory erasing COMPLETED.

Example Step 3
    [Documentation]    Verify that the application successfully enables the write protection.
    Read Console Until    [INFO] Step 3: Write protection enabled for the first half of the SRAM pages.

Example Step 4
    [Documentation]    Verify that the application fills all pages of given SRAM.
    Read Console Until    [INFO] Step 4: Memory filled with data.

Example Step 5
    [Documentation]    Verify that the application successfully checks protected and unprotected SRAM pages content.
    Read Console Until    [INFO] Step 5: Protected and unprotected SRAM checked successfully.
