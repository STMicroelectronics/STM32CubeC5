...
How to generate a finite sequence of pulses with precise timing control, followed by a permanent reset of the output signal.
...
__Step 1__:   Initializes the LPTIM instance, registers the callbacks for the update and the compare match events and starts both the LPTIM output channel and the LPTIM in interrupt mode.
