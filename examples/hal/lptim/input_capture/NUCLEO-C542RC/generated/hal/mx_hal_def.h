...
/* Exported constants --------------------------------------------------------*/
  ...
  /* *************************************************************
    LPTIM1 / LPDMA1_CH0: No software label has been defined for this peripheral instance
...
/**
  ...
  */
#define mx_example_lptim_init mx_lptim1_init
...
/**
  ...
  *                   mx_example_lptim
  */
#define mx_example_lptim_deinit mx_lptim1_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_lptim_handle_t Pointer on the handle on the LPTIM1 instance
  */
#define mx_example_lptim_gethandle mx_lptim1_gethandle
