...
*** Settings ***
Documentation       Automatic test for example_hal_uart_auto_baud_detect.
...
Example Step 3
    [Documentation]    verifies that the auto baud rate detection status completed successfully.
