...
/**
  * @brief  Initialize the mx_usart1_uart with HAL layer
  *         Name of the User label:
  *                   mx_example_uart
  * @retval hal_uart_handle_t Pointer on the handle on the USART1 instance
  */
#define mx_example_uart_init mx_usart1_uart_init
...
/**
  * @brief  De-Initialize the mx_usart1_uart with HAL layer
  *         Name of the User label:
  *                   mx_example_uart
  */
#define mx_example_uart_deinit mx_usart1_uart_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_uart_handle_t Pointer on the handle on the USART1 instance
  */
#define mx_example_uart_gethandle mx_usart1_uart_gethandle
