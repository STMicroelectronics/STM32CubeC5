...
#define MX_STATUS_WAKEUP_PORT                           HAL_GPIOB
#define MX_STATUS_WAKEUP_PIN                            HAL_GPIO_PIN_0
#define MX_STATUS_WAKEUP_INIT_STATE                     HAL_GPIO_PIN_RESET
#define MX_STATUS_WAKEUP_ACTIVE_STATE                   HAL_GPIO_PIN_SET
#define MX_STATUS_WAKEUP_INACTIVE_STATE                 HAL_GPIO_PIN_RESET
