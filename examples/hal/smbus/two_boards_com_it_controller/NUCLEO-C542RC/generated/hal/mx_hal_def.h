...
/**
  * @brief  Initialize the mx_i2c1_smbus with HAL layer
  *         Name of the User label:
  *                   mx_example_smbus
  * @retval hal_smbus_handle_t Pointer on the handle on the I2C1 instance
  */
#define mx_example_smbus_init mx_i2c1_smbus_init
...
/**
  * @brief  De-Initialize the mx_i2c1_smbus with HAL layer
  *         Name of the User label:
  *                   mx_example_smbus
  */
#define mx_example_smbus_deinit mx_i2c1_smbus_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_smbus_handle_t Pointer on the handle on the I2C1 instance
  */
#define mx_example_smbus_gethandle mx_i2c1_smbus_gethandle
