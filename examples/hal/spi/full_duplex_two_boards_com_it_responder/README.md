...
# __Example: *hal_spi_full_duplex_two_boards_com_it_responder*__
...
How to manage a full-duplex synchronous SPI communication as responder, in interrupt mode, using the HAL API.
...
__Step 2__: initiates the communication with the controller in a full duplex mode, using interrupts. It sends and receives data simultaneously. The SPI messages exchanged are null-terminated strings. A counter of attempts is reset when initiating the communication loop.
...
![spi-full-duplex-two-boards-com-it-responder_NominalCase](doc/spi-full-duplex-two-boards-com-it-responder_NominalCase.svg)

<details>
<summary> Expand this tab to visualize the sequence chart diagram of the communication attempts' mechanism. </summary>

![spi-full-duplex-two-boards-com-it-responder_AttemptsMechanism](doc/spi-full-duplex-two-boards-com-it-responder_AttemptsMechanism.svg)
...
- hal_spi_full_duplex_two_boards_com_it_controller: full duplex synchronous SPI communication of the controller with the responder, in interrupt mode.
