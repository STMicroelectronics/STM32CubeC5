...
elseif(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C562RE")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_debug_GCC_NUCLEO-C562RE ../../../../../../arch/cmsis/CMSIS/Core/Include ../generated/hal ../generated/utilities/basic_stdio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../stm32c5xx_drivers/timebases ../../../../../../utilities/basic_stdio ../../../../../../utilities/basic_stdio/interface_io ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC USE_TRACE=0 STM32C562xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC ${CPU_FLAGS})
endif()
