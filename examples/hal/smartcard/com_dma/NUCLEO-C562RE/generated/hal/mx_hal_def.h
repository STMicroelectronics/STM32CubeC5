...
/* Exported constants --------------------------------------------------------*/
  ...
  /* *************************************************************
    USART1 / LPDMA1_CH0: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for Channel instance
    ************************************************************* */

  /* *************************************************************
    USART1 / LPDMA1_CH1: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for Channel instance
    ************************************************************* */
...
#define mx_gpio_status_led_init mx_gpio_default_init
  ...
  /* ***********************************************************
      USART1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_usart1_smartcard with HAL layer
  *         Name of the User label:
  *                   mx_example_smartcard
  * @retval hal_smartcard_handle_t Pointer on the handle on the USART1 instance
  */
#define mx_example_smartcard_init mx_usart1_smartcard_init
...
/**
  * @brief  De-Initialize the mx_usart1_smartcard with HAL layer
  *         Name of the User label:
  *                   mx_example_smartcard
  */
#define mx_example_smartcard_deinit mx_usart1_smartcard_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      USART1: aliases for get handle functions
    *********************************************************** *//**
  ...
  * @retval hal_smartcard_handle_t Pointer on the handle on the USART1 instance
  */
#define mx_example_smartcard_gethandle mx_usart1_smartcard_gethandle
