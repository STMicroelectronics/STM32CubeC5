...
# __Example: *hal_rng_custom_config*__
...
__Step 1__: initializes RNG with custom configuration.
...
The configuration is set to "Custom Config" among the following compliant settings:
...
Custom configuration used in the example is not the same described by reference manual to proof that many customized configuration are working but the recommended configuration is provided by reference manual.
