...
# __Example: *hal_rng_candidate_nist_config*__
...
__Step 1__: initializes RNG with the "NIST Candidate SP800-90B" compliant configuration.
...
The configuration is set to "NIST Candidate SP800-90B" among the following compliant settings:
