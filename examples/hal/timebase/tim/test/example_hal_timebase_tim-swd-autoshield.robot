...
*** Settings ***
Documentation       Automatic test for example_hal_timebase_tim.
...
Example Step 2
    ...
    Comment    Check that the toggling frequency is 1Hz.
    Check Frequency    MX_STATUS_LED    1Hz    duty_cycle=0.5
