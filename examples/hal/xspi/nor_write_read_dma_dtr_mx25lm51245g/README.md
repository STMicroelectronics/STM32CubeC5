...
# __Example: *hal_xspi_nor_write_read_dma_dtr_mx25lm51245g*__
...
How to program and read a selected page of the MX25LM51245G Octo-SPI NOR flash memory with the HAL API, in DMA mode.
...
__Step 3__: Erases the first 4Kbyte sector of the memory, in DMA mode, by executing the Sector Erase command.

__Step 4__: Writes the TX buffer to the first 256-byte page of the first sector, in DMA mode, by executing the Program Page command.

__Step 5__: Reads back the written TX buffer, in DMA mode, from the memory by executing the Read command.
...
- DMA is enabled to handle the transmission and reception of commands.
...
```text
@startuml
@startditaa{doc/example_xspi_nor_write_read_dma_dtr_mx25lm51245g-setup.png} -E  -S
/-------------------------------------------\
|                    /--------------------+ |
|                    |                    | |
|                    |                    | |
...
```
-->
![example_xspi_nor_write_read_dma_dtr_mx25lm51245g-setup](doc/example_xspi_nor_write_read_dma_dtr_mx25lm51245g-setup.png)
