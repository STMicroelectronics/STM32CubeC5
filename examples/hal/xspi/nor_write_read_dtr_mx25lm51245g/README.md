...
# __Example: *hal_xspi_nor_write_read_dtr_mx25lm51245g*__
...
How to program and read a selected page of the MX25LM51245G Octo-SPI NOR flash memory with the HAL API, in automatic status-polling mode.
...
__Step 4__: writes the TX buffer to the first 256-byte page of the first sector, in automatic polling mode, by executing the Program Page command.

__Step 5__: reads back the written TX buffer from the memory by executing the Read command.
...
```text
@startuml
@startditaa{doc/example_xspi_nor_write_read_dtr_mx25lm51245g-setup.png} -E  -S
/-------------------------------------------\
|                    /--------------------+ |
|                    |                    | |
|                    |                    | |
...
```
-->
![example_xspi_nor_write_read_dtr_mx25lm51245g-setup](doc/example_xspi_nor_write_read_dtr_mx25lm51245g-setup.png)
