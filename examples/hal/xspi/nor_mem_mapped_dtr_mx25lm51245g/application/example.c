/**
  ...
  *                  in memory-mapped DTR mode with HAL API.
  ******************************************************************************
  *
...
app_status_t app_process(void)
{
  ...
  /** ########## Step 2 ##########
    ...
    * Enable write operation in Single-SPI mode, then configure the memory to enter Octal DTR mode.
    */
  ...
  PRINTF("[INFO] Step 2: Memory configuration in DTR mode COMPLETED.\n");
  ...
  /** ########## Step 4 ##########
    * Enables the memory-mapped mode for octal DTR read and write operations.
    */
  if (OctalWriteEnable() != EXEC_STATUS_OK)
  {
    goto _app_process_exit;
  ...
  PRINTF("[INFO] Step 4: Memory configured for octal read/write in memory-mapped mode.\n");
  ...
  PRINTF("[INFO] Step 6: Memory write COMPLETED.\n");
  /** ########## Step 7 ##########
