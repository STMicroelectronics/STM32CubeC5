...
# __Example: *hal_xspi_nor_write_read_it_dtr_mx25lm51245g*__
...
How to program in DTR mode (double-transfer rate) and read a selected page of the MX25LM51245G Octo-SPI NOR flash memory with the HAL API, in interrupt mode.
...
__Step 1__: Configures and initializes the XSPI instance and registers the user callbacks for XSPI events: TX/RX, command transfer completion, and transfer errors.

__Step 2__: Configures the MX25LM51245G NOR memory in DTR (double-transfer rate) and octal I/O modes.

__Step 3__: Erases the first 4Kbyte sector of the memory, in interrupt mode, by executing the Sector Erase command.

__Step 4__: Writes the TX buffer to the first 256-byte page of the first sector, in interrupt mode, by executing the Program Page command.

__Step 5__: Reads back the written TX buffer, in interrupt mode, from the memory by executing the Read command.

__Step 6__: Checks that the read data matches the written one.

__Step 7__: Deinitializes the XSPI instance.
...
[INFO] Step 2: Memory configuration COMPLETED.
[INFO] Step 3: Memory erasing COMPLETED.
[INFO] Step 4: Memory programming COMPLETED.
[INFO] Step 5: Memory read COMPLETED.
[INFO] Step 6: Data written and read match.
[INFO] Step 7: de-init
```
...
```text
@startuml
@startditaa{doc/example_xspi_nor_write_read_it_dtr_mx25lm51245g-setup.png} -E  -S
/-------------------------------------------\
|                    /--------------------+ |
|                    |                    | |
|                    |                    | |
...
```
-->
![example_xspi_nor_write_read_it_dtr_mx25lm51245g-setup](doc/example_xspi_nor_write_read_it_dtr_mx25lm51245g-setup.png)
...
More information about the MX25LM51245G Octo-SPI NOR flash memory can be found in this [datasheet](https://www.macronix.com/Lists/Datasheet/Attachments/8729/MX25LM51245G,%203V,%20512Mb,%20v1.1.pdf).
