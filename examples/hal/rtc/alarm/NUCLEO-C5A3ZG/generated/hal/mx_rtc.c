...
system_status_t mx_rtc_init(void)
{
  ...
  calendar_date.wday = HAL_RTC_WEEKDAY_MONDAY;
  calendar_date.mon = HAL_RTC_MONTH_DECEMBER;
  calendar_date.mday = 7U;
  calendar_date.year = 20U;

  hal_rtc_time_t calendar_time;
  calendar_time.am_pm = HAL_RTC_TIME_FORMAT_AM_24H;
  calendar_time.hour = 2U;
  ...
  alarm_a_config.auto_clear = HAL_ALARM_AUTO_CLEAR_DISABLE;
  ...
  alarm_a_date_time.mday_wday_selection = HAL_RTC_ALARM_DAY_TYPE_SEL_WEEKDAY;
  alarm_a_date_time.wday_mday.wday = HAL_RTC_WEEKDAY_MONDAY;
  alarm_a_date_time.time.am_pm = HAL_RTC_TIME_FORMAT_AM_24H;
  alarm_a_date_time.time.hour = 2U;
  alarm_a_date_time.time.min = 20U;
  alarm_a_date_time.time.sec = 30U;
