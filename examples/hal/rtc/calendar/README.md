...
# __Example: *hal_rtc_calendar*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to configure the RTC calendar through the HAL API.
...
__Step 2__: Displays the updated time and date.

__Step 3__: Checks for RTC Reset Type

       - On Power-On Reset without a Battery Connected to the VBAT Pin: The RTC is reset and the configuration is lost.
 
       - In any other Reset situation: The RTC stay active and the configuration is not lost. The Current time and date are updated and displayed on the terminal.

__End of example__: This example is repeated endlessly (The Current time and date are updated and displayed on the terminal).
You can verify that the example runs properly via the status LED.
When enabling use trace, it will printf the time, date and a message for the type of reset that occurred.

If you enable `USE_TRACE`, you can follow these execution steps in the terminal logs:

```text
[INFO] Step 1: The RTC instance is initialized and the calendar time and date are set.
[INFO] Step 2: Time: 12:00:00
[INFO] Step 2: Date: 07-31-2026
[INFO] Step 3: Power On Reset occurred
[INFO] Step 3: Reset occurred
...
```
