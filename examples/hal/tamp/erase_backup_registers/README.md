...
# __Example: *hal_tamp_erase_backup_registers*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to automatically erase the backup 0 register when an external tamper event occurs, using the TAMP HAL APIs.
...
[INFO] Step 3: Tamper STARTED. Press the user button to generate a tamper detection....
[INFO] Step 4: User button PRESSED. Tamper event DETECTED.
...
<!--
@startuml
@startditaa{doc/example_hal_tamp_erase_backup_registers.png}
    +---------------------------+
...
![example_hal_tamp_erase_backup_registers](doc/example_hal_tamp_erase_backup_registers.png)
