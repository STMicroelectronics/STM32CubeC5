...
Example Step 2
    [Documentation]    Hash data with HMAC sha256 algorithms in suspension mode, with different key for each handle.
    ...    of a plaintext using the HMAC-SHA256 algorithm.
    ...    Step 2.1: Configures the HASH peripheral.
    ...    Step 2.2: Suspends the IT Computation process.
    ...    Step 2.3: Generates and verifies a MAC using SHA265 algorithm with different vectors.
    ...    Step 2.4: Resumes the IT Computation process.
