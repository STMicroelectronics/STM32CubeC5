...
*** Settings ***
Documentation       Automatic test for example_hal_hash_auth_hmac_sha.
...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2: MAC generation and verification using SHA256 algorithm COMPLETED.
