...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      COMP1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_comp1 with HAL layer
  *         Name of the User label:
  *                   mx_example_comp
  * @retval hal_comp_handle_t Pointer on the handle on the COMP1 instance
  */
#define mx_example_comp_init mx_comp1_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      COMP1: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_comp1 with HAL layer
  *         Name of the User label:
  *                   mx_example_comp
  */
#define mx_example_comp_deinit mx_comp1_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      COMP1: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for COMP1
  *         Name of the User label:
  *                   mx_example_comp
  * @retval hal_comp_handle_t Pointer on the handle on the COMP1 instance
  */
#define mx_example_comp_gethandle mx_comp1_gethandle

  /* *************************************************************
    COMP1 / EXTI34: No EXTI software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for mx_comp1_exti34_gethandle
    ************************************************************* */
