...
/* Aliases of TX Channels labels */
#define MY_TX_CH_ID                            HAL_ETH_TX_CHANNEL_0
#define MY_TX_CH_MAX_APP_BUFF_NUM              10UL
#define MY_TX_CH_DESC_ALIGN_SZ_BYTE            24UL

/* Aliases of RX Channels labels */
#define MY_RX_CH_ID                            HAL_ETH_RX_CHANNEL_0
#define MY_RX_CH_MAX_APP_BUFF_NUM              10UL
#define MY_RX_CH_DESC_ALIGN_SZ_BYTE            24UL
#define MY_RX_CH_RX_BUFFER_LEN_BYTE            1520UL
