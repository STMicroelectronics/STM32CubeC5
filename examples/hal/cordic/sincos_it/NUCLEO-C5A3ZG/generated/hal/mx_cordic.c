...
hal_cordic_handle_t *mx_cordic_init(void)
{
  ...
  HAL_CORTEX_NVIC_SetPriority(CORDIC_IRQn, HAL_CORTEX_NVIC_PREEMP_PRIORITY_0, HAL_CORTEX_NVIC_SUB_PRIORITY_0);
