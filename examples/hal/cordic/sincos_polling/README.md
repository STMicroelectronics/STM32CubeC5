...
# __Example: *hal_cordic_sincos_polling*__
...
How to calculate sines and cosines array in polling mode, using the CORDIC HAL API.
...
__Step 3__: Starts CORDIC calculation in polling mode.

__Step 4__: Compares the CORDIC results to the reference values.
