...
*** Settings ***
Documentation       Automatic test for example_hal_cordic_sincos_polling.
...
Example Step 3
    [Documentation]    Starts CORDIC calculation in polling mode.
    Comment    No Check.

Example Step 4
    [Documentation]    Compares the CORDIC results to the reference values.
    Comment    No Check
