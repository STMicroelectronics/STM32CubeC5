...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      CORDIC: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_cordic with HAL layer
  *         Name of the User label:
  *                   mx_example_cordic
  * @retval hal_cordic_handle_t Pointer on the handle on the CORDIC instance
  */
#define mx_example_cordic_init mx_cordic_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      CORDIC: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_cordic with HAL layer
  *         Name of the User label:
  *                   mx_example_cordic
  */
#define mx_example_cordic_deinit mx_cordic_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      CORDIC: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for CORDIC
  *         Name of the User label:
  *                   mx_example_cordic
  * @retval hal_cordic_handle_t Pointer on the handle on the CORDIC instance
  */
#define mx_example_cordic_gethandle mx_cordic_gethandle
