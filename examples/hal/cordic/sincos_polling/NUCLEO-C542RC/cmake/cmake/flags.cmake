...
if(CMAKE_BUILD_TYPE STREQUAL "release_GCC_NUCLEO-C542RC")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_release_GCC_NUCLEO-C542RC ../../../../../../arch/cmsis/CMSIS/Core/Include ../../../../../../arch/cmsis_dsp/Include ../../../../../../arch/cmsis_dsp/PrivateInclude ../generated/hal ../generated/parts/led ../../../../../../part_drivers/led/gpio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../stm32c5xx_drivers/timebases ../../application)
...
elseif(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C542RC")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_debug_GCC_NUCLEO-C542RC ../../../../../../arch/cmsis/CMSIS/Core/Include ../../../../../../arch/cmsis_dsp/Include ../../../../../../arch/cmsis_dsp/PrivateInclude ../generated/hal ../generated/parts/led ../../../../../../part_drivers/led/gpio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../stm32c5xx_drivers/timebases ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC STM32C542xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC ${CPU_FLAGS})
endif()
