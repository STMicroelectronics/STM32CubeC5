/**
  ******************************************************************************
  * file           : example.c
  * brief          : How to calculate sines and cosines array in polling mode using
                     the CORDIC HAL APIs
  ******************************************************************************
  *
...
app_status_t app_process(void)
{
  ...
  /** ########## Step 3 ##########
    * Starts CORDIC calculation in polling mode.
    */
  if (HAL_CORDIC_Calculate(pCORDIC, &SrcBuffer, &DstBuffer, TIMEOUT) != HAL_OK)
  {
  ...
  /** ########## Step 4 ##########
    * Compares the CORDIC results to the reference values.
