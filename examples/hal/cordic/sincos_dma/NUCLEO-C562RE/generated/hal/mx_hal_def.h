...
#define mx_example_cordic_init           mx_cordic_cfg1_hal_init
...
#define mx_example_cordic_deinit            mx_cordic_cfg1_hal_deinit
...
#define mx_example_cordic_gethandle         mx_cordic_hal_gethandle
