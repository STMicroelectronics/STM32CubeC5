...
*** Settings ***
Documentation       Automatic test for example_hal_cordic_sincos_dma.
...
Example Step 3
    [Documentation]    Starts CORDIC calculation in DMA mode.
    Comment    No Check.

Example Step 4
    [Documentation]    Waits for the CORDIC read DMA transfer completion.
