...
/**
  * @brief  Initialize the mx_spi1_i2s with HAL layer
  *         Name of the User label:
  *                   MX_I2Sx
  * @retval hal_i2s_handle_t Pointer on the handle on the SPI1 instance
  */
...
/**
  * @brief  De-Initialize the mx_spi1_i2s with HAL layer
  *         Name of the User label:
  *                   MX_I2Sx
  */
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  * @retval hal_i2s_handle_t Pointer on the handle on the SPI1 instance
  */
#define mx_i2sx_gethandle mx_spi1_i2s_gethandle
