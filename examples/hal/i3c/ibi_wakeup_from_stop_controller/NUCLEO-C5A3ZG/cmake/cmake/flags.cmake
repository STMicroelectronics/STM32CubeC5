...
elseif(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C5A3ZG")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_debug_GCC_NUCLEO-C5A3ZG ../../../../../../arch/cmsis/CMSIS/Core/Include ../generated/hal ../generated/parts/led ../generated/utilities/basic_stdio ../../../../../../part_drivers/led/gpio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../stm32c5xx_drivers/timebases ../../../../../../utilities/basic_stdio ../../../../../../utilities/basic_stdio/interface_io ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC HAL_PWR_STOP_MODE=HAL_PWR_STOP0_MODE MX_STATUS_WAKEUP_PIN=HAL_GPIO_PIN_0 MX_STATUS_WAKEUP_PIN_ACTIVE_STATE=HAL_GPIO_PIN_SET MX_STATUS_WAKEUP_PIN_GPIO_PORT=HAL_GPIOA MX_STATUS_WAKEUP_PIN_INACTIVE_STATE=HAL_GPIO_PIN_RESET USE_TRACE=0 STM32C5A3xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC ${CPU_FLAGS})
endif()
