...
hal_i3c_handle_t *mx_i3c1_init(void)
{
  ...
  i3c_tgt_config_payload_entdaa.ibi_payload          = HAL_I3C_IBI_PAYLOAD_ENABLED;
  ...
  i3c_tgt_ibi_config.ibi_payload_size_byte = HAL_I3C_TGT_PAYLOAD_3_BYTE;
  i3c_tgt_ibi_config.pending_read_mdb      = HAL_I3C_PENDING_READ_MDB_DISABLED;
  if (HAL_I3C_TGT_SetConfigIBI(&hI3C1, &i3c_tgt_ibi_config) != HAL_OK)
  {
    return NULL;
  }

 /* Enable the IBI request */
  if (HAL_I3C_TGT_EnableIBI(&hI3C1) != HAL_OK)
  {
    return NULL;
  }
