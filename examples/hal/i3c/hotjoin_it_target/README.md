...
# __Example: *hal_i3c_hotjoin_it_target*__
...
How to an I3C target using the HAL API in interrupt (IT) mode to HotJoin an active communication via I3C bus.
...
This example demonstrates how multiple target application participates in a I3C communication via a HotJoin principle using the STM32 HAL API in interrupt-driven (IT) mode.
...
[INFO] Step 2: HotJoin process COMPLETED.
[ERROR] Step 2: Error occurs during HotJoin process: 0xXX
```
...
To test this example with the controller, you can use the corresponding *hal_i3c_hotjoin_it_controller* example pack.
...
<!--
@startuml
@startditaa{doc/example_hal_i3c_hotjoin_it_target-setup.png} -E -S
    /-------------------------\                     /-------------------------\
    |    /--------------------+                     +--------------\          |
...
![example_hal_i3c_hotjoin_it_target-setup](doc/example_hal_i3c_hotjoin_it_target-setup.png)
