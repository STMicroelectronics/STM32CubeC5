...
*** Settings ***
Documentation       Automatic test for example_hal_i3c_private_i2c_dma_controller.
...
${TEST_ID} Scenario adherence
    ...
    Init I2c    I2C_SCL    I2C_SDA    ${TARGET_ADDRESS}    baudrate=${BAUDRATE}    slave_txloop_enable=${False}    disable_clock_stretching=${True}
...
*** Keywords ***
Example Step 1
    [Documentation]    configures and initializes the I3C instance, the NVIC and the DMA channels.
