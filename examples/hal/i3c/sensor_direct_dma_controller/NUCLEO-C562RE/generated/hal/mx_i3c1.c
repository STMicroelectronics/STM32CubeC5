...
hal_i3c_handle_t *mx_i3c1_init(void)
{
  ...
  if (HAL_DMA_SetConfigPeriphDirectXfer(&hLPDMA1_CH1, &xfer_cfg_i3c1_tx_dma) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_I3C_SetTxDMA(&hI3C1, &hLPDMA1_CH1) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_DMA_SetConfigPeriphDirectXfer(&hLPDMA1_CH2, &xfer_cfg_i3c1_rx_dma) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_I3C_SetRxDMA(&hI3C1, &hLPDMA1_CH2) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_DMA_SetConfigPeriphDirectXfer(&hLPDMA1_CH0, &xfer_cfg_i3c1_tc_dma) != HAL_OK)
  {
    return NULL;
  }
  ...
  /* Link the transmit DMA handle to the I3C1 handle */
  if (HAL_I3C_SetTcDMA(&hI3C1, &hLPDMA1_CH0) != HAL_OK)
  {
    return NULL;
  }
