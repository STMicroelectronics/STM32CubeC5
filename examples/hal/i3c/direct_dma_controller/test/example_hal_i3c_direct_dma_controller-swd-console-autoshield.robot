...
*** Settings ***
Documentation       Automatic test for example_hal_i3c_direct_dma_controller.
...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2: DAA process and transfer context configuration COMPLETED.

Example Step 3
    [Documentation]    The process of the Dynamic Address Assignment is completed.
    Read Console Until    [INFO] Step 3: Data transfer and reception completed.
    ${active_level}=    Read Test Variable    MX_STATUS_LED_ACTIVE_STATE
    Check Pin    MX_STATUS_LED    ${active_level}    timeout=1s
    Check Integer Variable    ExecStatus    ${EXEC_STATUS_OK}    timeout=1
    Read Console Until    [INFO] Controller - GETMWL = 0x04 , GETMRL = 0x04 , GETPID = 0x281381100 , GETBCR = 0x2A , GETDCR = 0xC6
