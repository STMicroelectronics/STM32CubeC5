...
/**
  * @brief  Initialize the mx_i3c1 with HAL layer
  *         Name of the User label:
  *                   mx_example_i3c
  * @retval hal_i3c_handle_t Pointer on the handle on the I3C1 instance
  */
#define mx_example_i3c_init mx_i3c1_init
...
/**
  * @brief  De-Initialize the mx_i3c1 with HAL layer
  *         Name of the User label:
  *                   mx_example_i3c
  */
#define mx_example_i3c_deinit mx_i3c1_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      I3C1: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for I3C1
  *         Name of the User label:
  *                   mx_example_i3c
  * @retval hal_i3c_handle_t Pointer on the handle on the I3C1 instance
  */
#define mx_example_i3c_gethandle mx_i3c1_gethandle
