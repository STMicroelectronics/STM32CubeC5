...
# __Example: *hal_ccb_protected_ecdsa_blob_creation*__
...
[INFO] Step 2.2: ECDSA private key wrapping COMPLETED.
[INFO] Step 2.3: Blob creation for ECDSA verification COMPLETED.
[INFO] Step 3: de-init.
```
