...
/** ########## Step 2 ##########
  *  Performs protected blob creation and signature generation using ECDSA.
  */
app_status_t app_process(void)
{
  ...
  PRINTF("[INFO] Step 2.2: ECDSA private key wrapping COMPLETED.\n");

  /*
   * 2.3 Blob creation check for ECDSA
   */
  ...
  PRINTF("[INFO] Step 2.3: Blob creation for ECDSA verification COMPLETED.\n");
