...
#define mx_example_pka_init mx_pka_init
  ...
  /* *************************************************************
    TAMP: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for mx_tamp_init
    ************************************************************* */
...
#define mx_example_pka_deinit mx_pka_deinit
  ...
  /* *************************************************************
    TAMP: No software label has been defined for this peripheral instance
      in the STM32CubeMX2 configuration panel.
      As a result, no aliases are generated for mx_tamp_deinit
    ************************************************************* */
