...
/**
  * configure and enable clock for PKA
  */
system_status_t mx_rcc_pka_clock_config(void)
{
  /* Peripherals using HSIDIV3 (48 MHz):
    PKA
  */
...
/**
  * Deactivate clock for PKA
  */
system_status_t mx_rcc_pka_clock_deactivate(void)
{
  if (mx_rcc_hsidiv3_clock_deactivate() != SYSTEM_OK)
  {
    return SYSTEM_CLOCK_ERROR;
...
/**
  * configure and enable clock for TAMP
  */
