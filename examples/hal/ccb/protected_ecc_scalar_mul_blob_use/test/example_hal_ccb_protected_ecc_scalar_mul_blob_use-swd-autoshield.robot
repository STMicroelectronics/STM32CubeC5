...
Example Step 2.3
    [Documentation]    Verify that the ECC scalar multiplication operation using the wrapped completed successfully.
    Comment    ECC scalar multiplication operation COMPLETED.

Example Step 2.4
    [Documentation]    Check the output point against expected values to confirm correct ECC scalar multiplication result.
    Comment    ECC scalar multiplication result verified COMPLETED.
