...
/* ########### Aliases to initialization functions ########### */
  ...
  /* ***********************************************************
      LPDMA1_CH0: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_lpdma1_ch0 with HAL layer
  *         Name of the User label:
  *                   mx_dma_triggering_channel
  * @retval hal_dma_handle_t Pointer on the handle on the LPDMA1_CH0 instance
  */
#define mx_dma_triggering_channel_init mx_lpdma1_ch0_init

  /* ***********************************************************
      LPDMA1_CH1: aliases for initialization functions
    *********************************************************** */

/**
  * @brief  Initialize the mx_lpdma1_ch1 with HAL layer
  *         Name of the User label:
  *                   mx_dma_triggered_channel
  * @retval hal_dma_handle_t Pointer on the handle on the LPDMA1_CH1 instance
  */
#define mx_dma_triggered_channel_init mx_lpdma1_ch1_init
...
/* ########### Aliases to De-Initialization functions ########### */
  ...
  /* ***********************************************************
      LPDMA1_CH0: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_lpdma1_ch0 with HAL layer
  *         Name of the User label:
  *                   mx_dma_triggering_channel
  */
#define mx_dma_triggering_channel_deinit mx_lpdma1_ch0_deinit

  /* ***********************************************************
      LPDMA1_CH1: aliases for De-Initialization functions
    *********************************************************** */

/**
  * @brief  De-Initialize the mx_lpdma1_ch1 with HAL layer
  *         Name of the User label:
  *                   mx_dma_triggered_channel
  */
#define mx_dma_triggered_channel_deinit mx_lpdma1_ch1_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      LPDMA1_CH0: aliases for get handle functions
    *********************************************************** *//**
  ...
  * @retval hal_dma_handle_t Pointer on the handle on the LPDMA1_CH0 instance
  */
#define mx_dma_triggering_channel_gethandle mx_lpdma1_ch0_gethandle

  /* ***********************************************************
      LPDMA1_CH1: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for LPDMA1_CH1
  *         Name of the User label:
  *                   mx_dma_triggered_channel
  * @retval hal_dma_handle_t Pointer on the handle on the LPDMA1_CH1 instance
  */
#define mx_dma_triggered_channel_gethandle mx_lpdma1_ch1_gethandle
