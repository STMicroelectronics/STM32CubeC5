...
*** Settings ***
Documentation       Automatic test for example_hal_i2c_two_boards_com_it_controller.
...
Example Step 4
    [Documentation]    The controller expects to receive the message back in interrupt mode.
