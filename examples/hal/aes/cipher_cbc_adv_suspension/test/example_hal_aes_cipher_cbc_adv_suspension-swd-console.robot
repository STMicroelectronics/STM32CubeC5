...
Example Step 1
    ...
    Read Console Until    [INFO] Step 1.1: AES initialization COMPLETED.
...
Example Step 2
    ...
    ...    by setting the Suspendflag. Followed by a decryption in IT mode,
    ...    then Resumes the IT encryption process.
    Read Console Until    [INFO] Step 2.1: Suspension of IT encryption process COMPLETED.
    Read Console Until    [INFO] Step 2.2: Configuration of the AES peripheral to work with GCM algorithm COMPLETED.
    Read Console Until
    ...    [INFO] Step 2.3: Authenticated Decryption with associated data (AEAD) of a known text COMPLETED.
    Read Console Until    [INFO] Step 2.4: Resumption the IT encryption process COMPLETED.
