...
# __Example: *hal_aes_cipher_cbc*__
...
__Step 1__: AES initialization and configuration
...
```"USE_TRACE"
[INFO] Step 1: AES initialization and configuration of the AES peripheral to work with CBC mode COMPLETED.
