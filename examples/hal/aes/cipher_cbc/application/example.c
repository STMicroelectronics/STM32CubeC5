...
/** ########## Step 1 ##########
  * Step 1: Initializes and Configures the AES peripheral with the CBC algorithm with encryption method.
  */
app_status_t app_init(void)
{
  ...
  if (pAES != NULL)
  {
    PRINTF("[INFO] Step 1: AES initialization, configuration of the AES peripheral to work with CBC COMPLETED.\n");
