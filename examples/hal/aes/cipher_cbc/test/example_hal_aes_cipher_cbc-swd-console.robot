...
Example Step 1
    ...
    Read Console Until
    ...    [INFO] Step 1: AES initialization, configuration of the AES peripheral to work with CBC COMPLETED.

Example Step 2
    [Documentation]    Using the shared key to encrypts a known plaintext, followed by the verification
