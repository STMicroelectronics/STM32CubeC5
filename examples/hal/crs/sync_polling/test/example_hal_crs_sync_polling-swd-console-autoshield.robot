...
*** Settings ***
Documentation       Automatic test for example_hal_crs_sync_polling.
...
Test Tags           ip:hal_crs    profile:printf
...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2: CRS Synchronization started.

Example Step 3
    [Documentation]    Checks the synchronization is finished
    Read Console Until    [INFO] Step 3: CRS synchronization finished.
