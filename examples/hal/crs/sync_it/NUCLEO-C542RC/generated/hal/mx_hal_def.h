...
/**
  * @brief  Initialize the mx_crs with HAL layer
  *         Name of the User label:
  *                   mx_example_crs
  * @retval hal_crs_handle_t Pointer on the handle on the CRS instance
  */
#define mx_example_crs_init mx_crs_init
...
/**
  * @brief  De-Initialize the mx_crs with HAL layer
  *         Name of the User label:
  *                   mx_example_crs
  */
#define mx_example_crs_deinit mx_crs_deinit
...
/* ########### Aliases to get HAL handle functions ########### */
  ...
  /* ***********************************************************
      CRS: aliases for get handle functions
    *********************************************************** *//**
  * @brief  Get the HAL handle for CRS
  *         Name of the User label:
  *                   mx_example_crs
  * @retval hal_crs_handle_t Pointer on the handle on the CRS instance
  */
#define mx_example_crs_gethandle mx_crs_gethandle
