...
# __Example: *hal_crc_default*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the CRC HAL API to get a CRC code of a given buffer of data words (32-bit),
...
__Step 1__: CRC is initialized in app_init(). The default polynomial configuration for the CRC is referenced in the HAL CRC drivers.
...
[INFO] Step 2: Correct CRC value (0x13d6716b)
[INFO] Step 3: de-init
```
