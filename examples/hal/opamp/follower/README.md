...
# __Example: *hal_opamp_follower*__
...
<!--
@startuml
@startditaa{doc/example_hal_opamp_follower-setup.png}
...
![example_hal_opamp_follower-setup](doc/example_hal_opamp_follower-setup.png)
