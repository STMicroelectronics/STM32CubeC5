...
/******************************************************************************/
/* Exported functions for OPAMP1 in HAL layer */
/******************************************************************************/
hal_opamp_handle_t *mx_opamp1_init(void)
{
  ...
  opamp_config.speed_mode          = HAL_OPAMP_SPEED_MODE_NORMAL;
  opamp_config.configuration_mode  = HAL_OPAMP_MODE_FOLLOWER;
  ...
  HAL_GPIO_Init(HAL_GPIOA, PA1_PIN | PA6_PIN, &gpio_config);
...
void mx_opamp1_deinit(void)
{
  ...
  /* De-initialize all GPIOA pins associated with OPAMP1 */
  HAL_GPIO_DeInit(HAL_GPIOA, PA1_PIN | PA6_PIN);
}
