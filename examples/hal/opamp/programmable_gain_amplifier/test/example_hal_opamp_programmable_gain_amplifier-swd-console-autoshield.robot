...
*** Settings ***
Documentation       Automatic test for example_hal_opamp_programmable_gain_amplifier.
...
Test Tags           ip:hal_opamp    profile:printf
...
Example Step 4
    ...
    Check Integer Variable    AmplifiedVoltageValue_mV    ${min_voltage}    ${max_voltage}    timeout=2s
    ${active_level} =    Read Test Variable    MX_STATUS_LED_ACTIVE_STATE
    Check Pin    MX_STATUS_LED    ${active_level}    duration=1s
    Check Integer Variable    ExecStatus    ${EXEC_STATUS_OK}
    Read Console Until    [INFO] Step 4: Output voltage =
