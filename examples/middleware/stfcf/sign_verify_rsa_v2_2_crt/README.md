...
# __Example: *stfcf_sign_verify_rsa_v2_2_crt*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to perform the signature and the verification of a known message using the RSA PKCS#1 v2.2 with the chinese remainder theorem (CRT) representation compliant algorithm.
