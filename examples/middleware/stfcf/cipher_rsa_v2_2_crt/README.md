...
# __Example: *stfcf_cipher_rsa_v2_2_crt*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to perform encryption and decryption of a message using the RSA PKCS#1 v2.2 compliant algorithm.
...
It can be adapted to run with the software-based implementation.
...
The application executes the following __example steps__:
 ...
 - __Step 2__: Encrypts a known message and decrypts the computed ciphertext using the CRT private key representation.
...
[INFO] Step 2.1: Encrypt a known message using CRT private key representation COMPLETED.
