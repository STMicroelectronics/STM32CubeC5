...
*** Settings ***
Documentation       Automatic test for example_stfcf_shared_secret_gen_ecc_ecdh.
...
*** Keywords ***
Example Step 1
    [Documentation]    Initializes the RNG instance and configures the PSA key.
...
Example Step 2
    [Documentation]    Demonstrates how to establish and to verify the exchange of shared secret
    ...    using ECC algorithm configuration and operation in a single call method
    Read Console Until    [INFO] Step 2.1: Establish a shared secret COMPLETED.
    Read Console Until    [INFO] Step 2.2: Verify the exchange of the shared secret COMPLETED.
