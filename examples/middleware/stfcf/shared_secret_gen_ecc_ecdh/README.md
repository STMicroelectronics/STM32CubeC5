...
# __Example: *stfcf_shared_secret_gen_ecc_ecdh*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to establish and verify a shared secret using the ECDH algorithm.
...
This example demonstrates two ways of using the Cryptographic services:
   ...
   2. The verification of the exchange of the shared secret.
...
- __Step 2__: Demonstrates how to use the PSA Ref API to establish and to verify a shared secret using the ECDH algorithm.
...
[INFO] Step 2.2: Establish a shared secret COMPLETED.
[INFO] Step 2.3: Verify the exchange of the shared secret COMPLETED.
...
> **_NOTE:_** Vectors examples for ECDH are taken from "SP 800-56A / ECCCDH Primitive Test Vectors", available at: https://csrc.nist.gov/Projects/cryptographic-algorithm-validation-program/Component-Testing
