...
# __Example: *stfcf_cipher_aes_ecb*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to perform encryption and decryption using the AES ECB algorithm.
...
__Step 2__: Encryption and decryption using the AES ECB algorithm.
      Step 2.1: Performs an encryption the plaintext, followed by verification with the expected ciphertext, passing all the needed parameters.
      Step 2.2: Performs an encryption the ciphertext, followed by verification with the expected plaintext, passing all the needed parameters.
...
[INFO] Step 2.1: Encryption and verification of ciphertext COMPLETED.
[INFO] Step 2.2: Decryption and verification of plaintext COMPLETED.
...
> **_NOTE:_** NIST vectors examples for AES ECB are taken from NIST Special Publication 800-38A F.1.5 ECB-AES256.Encrypt, available at: https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf
