...
*** Settings ***
Documentation       Automatic test for example_stfcf_cipher_aes_ecb.
...
*** Keywords ***
Example Step 1
    [Documentation]    RNG initialization and PSA key configuration.
...
Example Step 2
    [Documentation]    perform an encryption and a decryption of a known ciphertext,
    ...    using the AES ECB algorithm.
    ...    2.1: Performs an encryption the plaintext, followed by verification with the expected,
    ...    passing all the needed parameters.
    ...    2.2: Performs an encryption the ciphertext, followed by verification with the expected plaintext,
    ...    passing all the needed parameters.
    Read Console Until    [INFO] Step 2.1: Encryption and verification of ciphertext COMPLETED.
    Read Console Until    [INFO] Step 2.2: Decryption and verification of plaintext COMPLETED.
