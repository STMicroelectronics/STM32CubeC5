...
Example Step 2
    ...
    ...    2.1: AES CBC encryption and decryption using single API call method COMPLETED.
    ...    2.2: AES CBC encryption and decryption using multiple API calls method COMPLETED.
