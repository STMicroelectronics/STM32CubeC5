...
*** Settings ***
Documentation       Automatic test for example_stfcf_cipher_aes_cbc.
...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2.1: AES CBC encryption and decryption using single API call method COMPLETED.
    Read Console Until    [INFO] Step 2.2: AES CBC encryption and decryption using multiple API calls method COMPLETED.
