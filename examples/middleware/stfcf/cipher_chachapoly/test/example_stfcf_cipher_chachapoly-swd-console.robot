...
*** Settings ***
Documentation       Automatic test for example_stfcf_cipher_chachapoly.
...
Example Step 2
    [Documentation]    Encrypts a known plaintext, followed by the verification of the generated ciphertext
    ...    and decrypts of a known ciphertext, followed by the verification of the generated plaintext.
    ...    2.1: Initializes the PSA Crypto API.
    ...    2.2: Encrypts and verifies directly a plainText passing all the needed parameters.
    ...    2.3: Decrypts and verifies directly ciphertext and tag passing all the needed parameters.
    ...    2.4: Destroys the PSA keys and clears PSA layer.
    Comment    Check application (app_process) runs without error
    Read Console Until    [INFO] Step 2.1: Encryption and verification COMPLETED.
    Read Console Until    [INFO] Step 2.2: Decryption and verification COMPLETED.
