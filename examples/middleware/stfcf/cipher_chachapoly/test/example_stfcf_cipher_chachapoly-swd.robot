...
Example Step 2
    ...
    ...    2.1: Encrypts and verifies directly a plainText passing all the needed parameters.
    ...    2.2: Decrypts and verifies directly ciphertext and tag passing all the needed parameters.
