/**
  ...
  *                  Framework (STFCF) to perform an authenticated encryption
  *                  and a verified decryption using the Chacha-Poly1305 algorithm.
  *
  ******************************************************************************
  *
...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
/* pointer referencing the RNG handle from the generated code */
...
/** Extract from IETF
  ...
  * 064  6f 6e 74 68 73 20 61 6e 64 20 6d 61 79 20 62 65  onths and might be
...
/** ########## Step 2 ##########
  ...
  * of a known ciphertext using the Chacha-Poly1305 algorithm.
...
app_status_t app_process(void)
{
  ...
  /** ########## Step 2.1 ##########
    * Encrypts and verifies directly a plainText passing all the needed parameters
    */
  ...
  PRINTF("[INFO] Step 2.1: Encryption and verification COMPLETED.\n");

  /** ########## Step 2.2 ##########
    * Decrypts and verifies directly a ciphertext and a tag passing all the needed parameters
    */
  ...
  PRINTF("[INFO] Step 2.2: Decryption and verification COMPLETED.\n");
