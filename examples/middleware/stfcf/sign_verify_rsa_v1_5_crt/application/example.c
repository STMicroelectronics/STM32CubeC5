/**
  ...
  *                  of a known message using the RSA PKCS#1 v1.5 compliant
  *                  algorithm.
  *
  ******************************************************************************
  *
...
app_status_t app_process(void)
{
  ...
  /** ########## Step 2.1 ##########
    * Computes directly the signature using the Chinese Remainder Theorem (CRT) representation.
    */
  ...
  PRINTF("[INFO] Step 2.1: Compute signature using the CRT private key representation COMPLETED.\n");
