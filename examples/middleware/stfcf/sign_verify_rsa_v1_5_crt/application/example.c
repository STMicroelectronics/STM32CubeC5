/**
  ...
  *                  and the verification of a known message using the RSA PKCS#1 v1.5
  *                  with the chinese remainder theorem (CRT) representation compliant algorithm.
  *
  ******************************************************************************
  *
...
/** ########## Step 2 ##########
  ...
  * of a known message using the RSA PKCS#1 v1.5 compliant algorithm.
...
app_status_t app_process(void)
{
  ...
  PRINTF("[INFO] Step 2.1: Compute signature using the chinese remainder theorem (CRT) representation COMPLETED.\n");

  /** ########## Step 2.2 ##########
    * Verifies the message with the previously computed signature
    */
  ...
  PRINTF("[INFO] Step 2.2: Verify the message with the previously computed signature COMPLETED.\n");
