...
*** Settings ***
Documentation       Automatic test for example_stfcf_integrity_hash_sha2.
...
Example Step 2
    [Documentation]    Demonstrates how to use the PSA Ref API to digest a message
    ...    using the SHA256 compliant algorithm in two ways:
    ...
    Read Console Until    [INFO] Step 2.1: Compute the digest using single API call method COMPLETED.
    Read Console Until    [INFO] Step 2.2: Compute the digest using multiple API calls method COMPLETED.
