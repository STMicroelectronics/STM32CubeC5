/**
  ...
  *                  Framework (STFCF) to perform the digest of a known message using
...
uint8_t Computed_Hash[sizeof(Expected_Hash)]; /* Signature length is modulus size/8U */
...
/** ########## Step 2 ##########
  * Demonstrates how to use the STFCF to digest a message
