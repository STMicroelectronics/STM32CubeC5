/**
  ...
  *                  Framework (STFCF) to perform an encryption and a decryption of a message using the RSA PKCS#1 v2.2
  *                  compliant algorithm.
  *
  ******************************************************************************
  *
...
app_status_t app_init(void)
{
  ...
  /* Set up the key location using PSA_CRYPTO_KWE_DRIVER_LOCATION
     to wrap the private key using STM32 Key Wrap Engine (KWE) */
  ...
  PRINTF("[INFO] cipher_rsa_v2_2_std.Step 2.0: Import PSA private key COMPLETED.\n");
...
/** ########## Step 2 ##########
  * Demonstrates how to use the STFCF to perform an encryption and a decryption of
  * a message using the RSA PKCS#1 v2.2 compliant algorithm.
  * This step is scheduled as follows:
  * Step 2.1: Encrypts the message using regular private key representation.
  * Step 2.2: Decrypts the message.
  */
app_status_t app_process(void)
{
  ...
  /** ########## Step 2.1 ##########
    * Encrypts message using regular private key representation.
    */
  /* Compute directly the encrypted message passing all the needed parameters */
  retval = psa_asymmetric_encrypt(key_handle_rsa_public,
  ...
  PRINTF("[INFO] Step 2.2: Message decryption COMPLETED.\n");
