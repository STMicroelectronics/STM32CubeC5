...
# __Example: *stfcf_cipher_rsa_v2_2_std*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to perform encryption and decryption of a known message using the RSA PKCS#1 v2.2 compliant algorithm.
...
This example demonstrates two ways of using the Cryptographic services:
   ...
   2. A decryption of a known ciphertext, followed by the verification of the generated plaintext.
...
The application executes the following __example steps__:
 ...
 - __Step 2__: Encrypts a known message and decrypts the computed ciphertext using the regular private key representation.
...
[INFO] Step 2.1: Message encryption COMPLETED.
[INFO] Step 2.2: Message decryption COMPLETED.
