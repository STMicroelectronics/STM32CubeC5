...
# __Example: *stfcf_sign_verify_rsa_v1_5_std*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Flexible Crypto Framework (STFCF) to perform the signature and the verification of a known message using the RSA PKCS#1 v1.5 compliant algorithm.
...
This example demonstrates two ways of using the Cryptographic services:
   1. The signature of the known message digest, followed by a comparison with the known signature.
   2. The verification of the message digest with the known signature.
...
The application executes the following __example steps__:
 ...
 - __Step 2__: Computes the signature of the message using the regular private key representation (modulus + exponent), so that generated signature can be compared to the known signature.
...
[INFO] Step 2.1: Compute signature COMPLETED.
...
> **_NOTE:_**sssVectors examples for RSA are taken from "psa_arch_tests\api-tests\dev_apis\crypto", available at https://github.com/ARM-software/psa-arch-tests.git
