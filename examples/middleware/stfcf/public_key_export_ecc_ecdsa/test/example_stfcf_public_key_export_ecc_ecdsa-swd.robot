...
Example Step 2
    ...
    ...    2.1: Export the public key from the wrapped private key.
    ...    2.2: Verify computed public key data size is the expected one.
...
Example Step 3
    ...
    ...    3.1: Destroy the PSA key and clear all data.
    ...    3.2: Clear all data associated with the PSA layer.
