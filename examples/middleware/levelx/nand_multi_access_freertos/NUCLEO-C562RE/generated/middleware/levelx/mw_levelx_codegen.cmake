...
set(generated_STMicroelectronics.levelx.0.0.1_LX_Core_condition "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:NAND Flash Core(#.*|$)>,>>,$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:NAND Flash Core(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:Board Part#.*Cgroup:Memory#.*Csub:W25N01GVXX Core(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:w25n01gvxx_nand_dma_os_itf(#.*|$)>,>>>>")
...
# description: 
set(generated_STMicroelectronics.levelx.0.0.1_Operating_System_Used "1")
...
# description: 
set(generated_STMicroelectronics.levelx.0.0.1_USE_W25N01GVXX_DMA_OS "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:NAND Flash Core(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:Board Part#.*Cgroup:Memory#.*Csub:W25N01GVXX Core(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:w25n01gvxx_nand_dma_os_itf(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.levelx.0.0.1_USE_W25Q128J_DMA_NO_OS "1")
...
# description: 
set(generated_STMicroelectronics.levelx.0.0.1_Use_NAND_Flash_Core "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:LevelX#.*Csub:NAND Flash Core(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.levelx.0.0.1_Use_NOR_Flash_Core "1")
