...
if(CMSIS_ENTIRE_generated_STMicroelectronics_syscalls_2_0_0)
  list(APPEND CMSIS_COMPONENTS_LIST "Cvendor:STMicroelectronics#Cclass:Utility#Cgroup:STM32CubeMX2 Config#Csub:syscalls#Cversion:2.0.0#generated:true")
endif()
...
if("Cvendor:STMicroelectronics#Cclass:Utility#Cgroup:STM32CubeMX2 Config#Csub:syscalls#Cversion:2.0.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_Utility_STM32CubeMX2_Config_syscalls_2_0_0")
  target_compile_definitions(generated_STMicroelectronics_syscalls_2_0_0 INTERFACE "$<${generated_STMicroelectronics.syscalls.2.0.0_Syscalls_Config}:-DCMSIS_USE_generated_Utility_STM32CubeMX2_Config_syscalls_2_0_0=1>")
endif()
