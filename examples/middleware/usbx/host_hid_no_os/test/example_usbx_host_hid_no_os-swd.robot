...
*** Settings ***
Documentation       Automatic test for example_usbx_host_hid_no_os.
...
*** Keywords ***
Example Step 1
    [Documentation]    USB HCD initialization
...
Example Step 3
    [Documentation]    Initialization of USBX HID Host Mouse and Keyboard Class.
