...
# __Example: *usbx_device_video_mjpeg_freertos*__

**Example version:** 2.0.0

How to configure a USB Communication Device Class "video_mjpeg" in RTOS mode based on USBX stack.
...
- __Step 3__: Initialization of USBX video_mjpeg Device Class.
...
- Plug the device running the video mjpeg example into a USB port on the PC.
- Open a camera application (Camera, ContaCam or VLC media player) then open the capture device and play the video on the PC host.
...
__USB PCD OTG HS__: is configured as indicated below:
...
Projects are provided for NUCLEO-C542RC, NUCLEO-C562RE, NUCLEO-C5A3ZG, NUCLEO-V873XJ, and STM32V873J-DK.
