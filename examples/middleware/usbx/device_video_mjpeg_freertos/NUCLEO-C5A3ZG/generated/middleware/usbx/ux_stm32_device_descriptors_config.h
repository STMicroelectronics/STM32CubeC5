...
#define USBD_UVC_USE_FRAME_BASE_H264            0U
#define USBD_UVC_USE_H264                       0U
#define USBD_UVC_USE_CAMERA                     0U
#define UVC_FRAME_WIDTH                         400
#define UVC_FRAME_HEIGHT                        240
#define UVC_CAM_FPS_FS                          10
#define UVC_CAM_FPS_HS                          5
/* Endpoint IN for VIDEO */
#define USBD_VIDEO_EPIN_ADDR                    0x81U
#define USBD_VIDEO_EPIN_TYPE                    UX_ISOCHRONOUS_ENDPOINT
#define USBD_VIDEO_EPIN_FS_MPS                  300
#define USBD_VIDEO_EPIN_FS_BINTERVAL            1
#if USBD_HIGH_SPEED_SUPPORTED == 1U
#define USBD_VIDEO_EPIN_HS_MPS                  512
#define USBD_VIDEO_EPIN_HS_BINTERVAL            1
