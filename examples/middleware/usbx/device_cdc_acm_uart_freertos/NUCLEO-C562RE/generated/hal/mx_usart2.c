...
hal_uart_handle_t *mx_usart2_hal_uart_init(void)
{
  ...
  HAL_GPIO_Init(HAL_GPIOA, HAL_GPIO_PIN_2 | HAL_GPIO_PIN_3, &gpio_config);

  /* Enable interrupt */
  HAL_CORTEX_NVIC_SetPriority(USART2_IRQn, HAL_CORTEX_NVIC_PREEMP_PRIORITY_8, HAL_CORTEX_NVIC_SUB_PRIORITY_0);
  ...
  HAL_CORTEX_NVIC_SetPriority(LPDMA1_CH0_IRQn, HAL_CORTEX_NVIC_PREEMP_PRIORITY_10, HAL_CORTEX_NVIC_SUB_PRIORITY_0);
  ...
  HAL_CORTEX_NVIC_SetPriority(LPDMA1_CH1_IRQn, HAL_CORTEX_NVIC_PREEMP_PRIORITY_10, HAL_CORTEX_NVIC_SUB_PRIORITY_0);
...
(void)HAL_UART_DeInit(&hUSART2);
  ...
  /* De-initialize all GPIO pins associated with USART2 */
  HAL_GPIO_DeInit(HAL_GPIOA, HAL_GPIO_PIN_3);
