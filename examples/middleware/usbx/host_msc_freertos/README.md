...
How to configure a USB host mass storage class to enumerate and communicate with a USB storage device in RTOS mode using the USBX stack.
...
__End of example__: After Step 3, the example is completed and the MSC host is ready to interact with the device.
...
- The host proceeds to file operations :
