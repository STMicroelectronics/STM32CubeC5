...
if(CMAKE_BUILD_TYPE STREQUAL "release_GCC_NUCLEO-C5A3ZG")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_release_GCC_NUCLEO-C5A3ZG ../../../../../../arch/cmsis/CMSIS/Core/Include ../generated/hal ../generated/middleware/filex ../generated/middleware/freertos ../generated/middleware/usbx ../generated/parts/led ../generated/utilities/advanced_trace ../../../../../../middleware/filex/common/inc ../../../../../../middleware/filex/ports/freertos/inc ../../../../../../middleware/freertos/include ../../../../../../middleware/freertos/portable/GCC/ARM_CM33_NTZ/non_secure ../../../../../../middleware/usbx/common/core/inc ../../../../../../middleware/usbx/common/usbx_host_classes/inc ../../../../../../middleware/usbx/interfaces/usbx_stm32_host_controllers ../../../../../../middleware/usbx/ports/freertos/inc ../../../../../../part_drivers/led/gpio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../utilities/advanced_trace/core ../../../../../../utilities/advanced_trace/interface_data ../../../../../../utilities/advanced_trace/templates ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC HSE_VALUE=16000000 STM32C5A3xx _RTE_)
...
elseif(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C5A3ZG")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC ../user_modifiable/_debug_GCC_NUCLEO-C5A3ZG ../../../../../../arch/cmsis/CMSIS/Core/Include ../generated/hal ../generated/middleware/filex ../generated/middleware/freertos ../generated/middleware/usbx ../generated/parts/led ../generated/utilities/advanced_trace ../../../../../../middleware/filex/common/inc ../../../../../../middleware/filex/ports/freertos/inc ../../../../../../middleware/freertos/include ../../../../../../middleware/freertos/portable/GCC/ARM_CM33_NTZ/non_secure ../../../../../../middleware/usbx/common/core/inc ../../../../../../middleware/usbx/common/usbx_host_classes/inc ../../../../../../middleware/usbx/interfaces/usbx_stm32_host_controllers ../../../../../../middleware/usbx/ports/freertos/inc ../../../../../../part_drivers/led/gpio ../../../../../../stm32c5xx_dfp/Include ../../../../../../stm32c5xx_drivers/hal ../../../../../../stm32c5xx_drivers/ll ../../../../../../utilities/advanced_trace/core ../../../../../../utilities/advanced_trace/interface_data ../../../../../../utilities/advanced_trace/templates ../../application)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC HSE_VALUE=16000000 STM32C5A3xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC ${CPU_FLAGS})
endif()
