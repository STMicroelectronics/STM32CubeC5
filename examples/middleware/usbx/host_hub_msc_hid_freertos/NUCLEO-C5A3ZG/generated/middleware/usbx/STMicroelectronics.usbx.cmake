...
if(CMSIS_ENTIRE_generated_STMicroelectronics_usbx_0_0_1)
  list(APPEND CMSIS_COMPONENTS_LIST "Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:HID_Keyboard_Host_Class#Cversion:2.1.0#generated:true")
  list(APPEND CMSIS_COMPONENTS_LIST "Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:HID_Mouse_Host_Class#Cversion:2.1.0#generated:true")
  list(APPEND CMSIS_COMPONENTS_LIST "Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:Host_Core#Cversion:2.1.0#generated:true")
  list(APPEND CMSIS_COMPONENTS_LIST "Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:MSC_Host_Class#Cversion:2.1.0#generated:true")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_Device_Controllers "1")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_Device_Core "1")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_HID_Host_Class "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_HID_Keyboard_Host_Class "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID Keyboard(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:HID_Keyboard_Host_Class(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_HID_Mouse_Host_Class "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID Mouse(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:HID_Mouse_Host_Class(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_HUB_Host_Class "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HUB(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_Host_Controllers "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Controllers Driver#.*Csub:Host(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_Host_Core "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Core#.*Csub:Host(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:Host_Core(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_MSC_Host_Class "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:MSC(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:MSC_Host_Class(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_usbx_core_condition "$<AND:$<NOT:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX#.*Csub:No_OS(#.*|$)>,>>>,$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Core#.*Csub:Host(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:Host_Core(#.*|$)>,>>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Controllers Driver#.*Csub:Host(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID(#.*|$)>,>>,$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID Mouse(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:HID_Mouse_Host_Class(#.*|$)>,>>>,$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HID Keyboard(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:HID_Keyboard_Host_Class(#.*|$)>,>>>,$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:MSC(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:MSC_Host_Class(#.*|$)>,>>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Host Class#.*Csub:HUB(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Core#.*Csub:Common(#.*|$)>,>>>")
...
if("Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:HID_Keyboard_Host_Class#Cversion:2.1.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_USB_STM32CubeMX2_Codegen_HID_Keyboard_Host_Class_2_1_0")
  target_compile_definitions(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Keyboard_Host_Class}:-DCMSIS_USE_generated_USB_STM32CubeMX2_Codegen_HID_Keyboard_Host_Class_2_1_0=1>")
  target_include_directories(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Keyboard_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/.>")
  target_sources(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Keyboard_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/mx_usbx_host_hid_keyboard.c>")
endif()

if("Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:HID_Mouse_Host_Class#Cversion:2.1.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_USB_STM32CubeMX2_Codegen_HID_Mouse_Host_Class_2_1_0")
  target_compile_definitions(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Mouse_Host_Class}:-DCMSIS_USE_generated_USB_STM32CubeMX2_Codegen_HID_Mouse_Host_Class_2_1_0=1>")
  target_include_directories(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Mouse_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/.>")
  target_sources(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_HID_Mouse_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/mx_usbx_host_hid_mouse.c>")
endif()

if("Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:Host_Core#Cversion:2.1.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_USB_STM32CubeMX2_Codegen_Host_Core_2_1_0")
  target_compile_definitions(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_Host_Core}:-DCMSIS_USE_generated_USB_STM32CubeMX2_Codegen_Host_Core_2_1_0=1>")
  target_include_directories(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_Host_Core}:${CMAKE_CURRENT_LIST_DIR}/.>")
  target_sources(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_Host_Core}:${CMAKE_CURRENT_LIST_DIR}/mx_usbx_host.c>")
endif()

if("Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:MSC_Host_Class#Cversion:2.1.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_USB_STM32CubeMX2_Codegen_MSC_Host_Class_2_1_0")
  target_compile_definitions(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_MSC_Host_Class}:-DCMSIS_USE_generated_USB_STM32CubeMX2_Codegen_MSC_Host_Class_2_1_0=1>")
  target_include_directories(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_MSC_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/.>")
  target_sources(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_MSC_Host_Class}:${CMAKE_CURRENT_LIST_DIR}/mx_usbx_host_msc.c>")
endif()
