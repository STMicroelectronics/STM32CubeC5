...
# description: 
set(generated_STMicroelectronics.usbx.0.0.1_Use_DFU_Device_Class "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:USBX Device Class#.*Csub:DFU(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:USB#.*Cgroup:STM32CubeMX2 Codegen#.*Csub:DFU_Device_Class(#.*|$)>,>>>")
...
if("Cvendor:STMicroelectronics#Cclass:USB#Cgroup:STM32CubeMX2 Codegen#Csub:DFU_Device_Class#Cversion:2.1.0#generated:true" IN_LIST CMSIS_COMPONENTS_LIST)  # TO BE DEFINED
  message(DEBUG "Using component generated_USB_STM32CubeMX2_Codegen_DFU_Device_Class_2_1_0")
  target_compile_definitions(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_DFU_Device_Class}:-DCMSIS_USE_generated_USB_STM32CubeMX2_Codegen_DFU_Device_Class_2_1_0=1>")
  target_include_directories(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_DFU_Device_Class}:${CMAKE_CURRENT_LIST_DIR}/.>")
  target_sources(generated_STMicroelectronics_usbx_0_0_1 INTERFACE "$<${generated_STMicroelectronics.usbx.0.0.1_Use_DFU_Device_Class}:${CMAKE_CURRENT_LIST_DIR}/mx_usbx_device_dfu.c>")
endif()
