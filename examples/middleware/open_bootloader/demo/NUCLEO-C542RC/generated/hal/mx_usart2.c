...
hal_uart_handle_t *mx_usart2_uart_init(void)
{
  ...
  uart_config.word_length = HAL_UART_WORD_LENGTH_9_BIT;
  ...
  if (HAL_UART_SetConfigAutoBaudRateMode(&hUSART2, HAL_UART_AUTO_BAUD_DET_ON_0X7F_FRAME) != HAL_OK)
  {
    return NULL;
  }
