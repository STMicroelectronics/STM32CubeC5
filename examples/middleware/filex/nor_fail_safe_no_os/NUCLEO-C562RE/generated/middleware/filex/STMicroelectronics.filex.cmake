...
set(generated_STMicroelectronics.filex.0.0.1_FX_Core_Condition "$<AND:$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:Core(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:Fault Tolerance Support(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:No_OS(#.*|$)>,>>,$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:nor_flash_itf(#.*|$)>,>>>")
...
# description: 
set(generated_STMicroelectronics.filex.0.0.1_Operating_System_Used "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:No_OS(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.filex.0.0.1_USE_FAULT_TOLERANCE_ENV "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:Fault Tolerance Support(#.*|$)>,>>")
...
# description: 
set(generated_STMicroelectronics.filex.0.0.1_USE_NOR_ENV "$<NOT:$<STREQUAL:$<FILTER:${CMSIS_COMPONENTS_LIST},INCLUDE,.*Cclass:File System#.*Cgroup:FileX#.*Csub:nor_flash_itf(#.*|$)>,>>")
