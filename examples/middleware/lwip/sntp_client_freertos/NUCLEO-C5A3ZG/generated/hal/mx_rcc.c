...
{
  /* Peripherals using HCLK (144 MHz):
    ETH1
  */
  ...
  */
  ...
  /* Peripherals using PSIS (100 MHz):
    ETH1
  */
  ...
  */
  ...
  if (HAL_RCC_LSE_Enable(HAL_RCC_LSE_ON, HAL_RCC_LSE_DRIVE_LOW) != HAL_OK)
  {
  ...
  /* Peripherals using ETH1_DIV (50 MHz):
    ETH1
  */
  if (HAL_RCC_ETH1_SetKernelClkPrescaler(HAL_RCC_ETH1_PRESCALER2) != HAL_OK)
  {
    return SYSTEM_CLOCK_ERROR;
  }
