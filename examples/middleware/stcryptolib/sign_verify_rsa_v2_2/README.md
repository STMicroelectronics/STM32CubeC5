...
# __Example: *stcryptolib_sign_verify_rsa_v2_2*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube firmware package.")

How to use the STM32 Cryptographic library to sign and to verify a message using the RSA PKCS#1 v2.2 compliant algorithm.
...
[INFO] Step 2.4: Verify signature COMPLETED.
...
Vectors examples for RSA are taken from "pyca cryptography / pkcs-1v2-1d2-vec/pss-vect.txt", available at https://github.com/pyca/cryptography/tree/master/vectors/cryptography_vectors/asymmetric/RSA
