...
Example Step 2
    [Documentation]    2.1: Demonstrates single call method.
    ...    2.2: Computes directly the signature using regular private key representation.
    ...    2.3: Computes directly the signature using the CRT private key representation.
    ...    2.4: Verifies the message with the known signature.
