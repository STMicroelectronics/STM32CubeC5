...
*** Settings ***
Documentation       Automatic test for example_stcryptolib_sign_verify_rsa_v2_2.
...
Example Step 2
    [Documentation]    Sign and to verify a message using the RSA PKCS#1 v2.2 compliant algorithm.
    Read Console Until    [INFO] Step 2.1: Generate digest of the known message COMPLETED.
    Read Console Until    [INFO] Step 2.2: Compute signature using the regular private key representation COMPLETED.
    Read Console Until    [INFO] Step 2.3: Compute signature using the CRT private key representation COMPLETED.
    Read Console Until    [INFO] Step 2.4: Verify signature COMPLETED.
