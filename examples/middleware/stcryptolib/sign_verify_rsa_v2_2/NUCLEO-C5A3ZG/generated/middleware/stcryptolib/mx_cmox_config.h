...
/**
  ******************************************************************************
  * @file    mx_cmox_config.h
  * @author  MCD Application Team
  * @brief   Header file for configuration of some algorithms
  ...
  * All rights reserved.
  *
  * This software is licensed under terms that can be found in the mx_stcryptolib_license.md file
  * in the same directory as the generated code.
  * If no mx_stcryptolib_license.md file comes with this software, it is provided AS-IS.
  *
  ******************************************************************************
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef MX_CMOX_CONFIG_H
#define MX_CMOX_CONFIG_H
...
/**
  * @defgroup MX_CMOX_SELECTED CMOX selected configurations
  * @{
  */

/**
  * @defgroup MX_CMOX_AES_GENERATED Generated AES configuration
  * @{
  */
...
/**
  * @brief Flag indicating the selected implementation of AES
  * @note  Value can be
  *        - @ref CMOX_AES_SMALL
  *        - @ref CMOX_AES_FAST
  */
...
/**
  * @defgroup MX_CMOX_GCM_GENERATED Generated GCM configuration
  * @{
  */
...
/**
  * @brief Flag indicating the selected implementation of GCM
  * @note  Value can be
  *        - @ref CMOX_GCM_SMALL
  *        - @ref CMOX_GCM_FAST
  */
...
/**
  * @defgroup MX_CMOX_MATH_GENERATED Generated Math customizations
  * @{
  */

/**
  * @brief Flag indicating the selected implementation for RSA low level mathematical functions
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for ECC 256 bits curves
...
/**
  * @brief Flag indicating the selected implementation for ECC 128 bits multiple curves
  *        low level mathematical functions
  * @note  Value can be
  *        - @ref CMOX_MATH_FUNCS_SMALL
  *        - @ref CMOX_MATH_FUNCS_FAST
...
/**
  * @brief Flag indicating the selected implementation for ECC curves not defined by the above
  *        low level mathematical functions
  * @note  Value can be
...
/**
  * @defgroup MX_CMOX_ECC_GENERATED Generated ECC customizations
  * @{
  */

/**
  * @brief Flag indicating the selected implementation for EDWARDS Ed25519 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for EDWARDS Ed448 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for NIST-R P-224 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for NIST-R P-256 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for NIST-R P-384 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for NIST-R P-521 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for NIST-K P-256 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-160 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-192 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-224 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-256 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-320 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-384 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-R P-512 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-160 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-192 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-224 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-256 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-320 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-384 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for BRAINPOOL-T P-512 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for ANSSI P-256 ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for OSCCA 256 bit ECC curves
  * @note  Value can be
...
/**
  * @brief Flag indicating the selected implementation for OSCCA 256 bit test ECC curves
  * @note  Value can be
...
/**
  * @defgroup MX_CMOX_RSA_GENERATED Generated RSA customizations
  * @{
  */

/**
  * @brief Flag indicating the selected private modular exponentiation implementation
  * @note  Value can be
