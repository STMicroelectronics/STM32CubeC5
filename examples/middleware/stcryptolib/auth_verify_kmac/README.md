...
# __Example: *stcryptolib_auth_verify_kmac*__

**Example version:** 2.0.0

[![User Manual](doc/read_the-UM.svg)](https://dev.st.com/stm32cube-docs/examples/arch-v1/en/index.html "An offline version is also available in the STM32Cube Firmware package.")

How to use the STM32 Cryptographic library to generate and to verify a message authentication code (MAC) of a plaintext using the SHA3 KMAC-128 algorithm.
...
using the KMAC-128 algorithm in two ways.
...
> **_NOTE:_** NIST vectors examples for KMAC are taken from:
"SHA-3 Derived Functions - cSHAKE / KMAC / TupleHash / ParallelHash", available at https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Standards-and-Guidelines/documents/examples/KMAC_samples.pdf
