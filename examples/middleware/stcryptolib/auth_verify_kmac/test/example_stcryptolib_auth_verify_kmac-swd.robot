...
*** Settings ***
Documentation       Automatic test for example_stcryptolib_auth_verify_kmac.
...
Example Step 2
    ...
    ...    using the KMAC algorithm in two ways.
    ...    2.1: Generates and verifies a message authentication code (MAC) using single API call method.
    ...    2.2: Verifies the message with the given authentication tag using single API call method.
    ...    2.3: Generates and verifies a message authentication code (MAC) using multiple API calls method.
    ...    2.4: Verifies the message with the given authentication tag using multiple API calls method.
