...
Example Step 2
    ...
    ...    2.1: Computes and verifies the digest message.
    ...    2.2: Computes and verifies the signature of the known message digest using a known random.
    ...    2.3: Computes and verifies the signature of the known message digest using a true random.
