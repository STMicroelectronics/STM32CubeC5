/**
  ...
  *                  library to encrypt and decrypt a message using the RSA
  *                  PKCS#1 v2.2 compliant algorithm.
  *
  ******************************************************************************
  *
...
uint8_t Working_Buffer[7000] __ALIGNED(4);
...
/** ---------------------------------------------------------------------
  * Extract from pyca cryptography / pkcs-1v2-1d2-vec/oaep-vect.txt
  * # Example 1: A 2048-bit RSA key pair
  * # -----------------------------------
  *
  * # Public key
  * # ----------
...
/** ########## Step 2 ##########
  * Demonstrates how to use the STM32 Cryptographic library to encrypt and to decrypt
  * a message using the RSA PKCS#1 v2.2 compliant algorithm.
  * This step is scheduled as follows:
  * Step 2.1: Compute and verify the message using regular private key representation COMPLETED.
  * Step 2.2: Compute and verify the message using CRT private key representation COMPLETED.
  * Step 2.3: Compute and verify the message using public key representation COMPLETED.
  */
app_status_t app_process(void)
{
  ...
  /** ########## Step 2.1 ##########
    * Computes and verifies the message using regular private key representation COMPLETED.
    */
  ...
  retval = cmox_rsa_pkcs1v22_decrypt(&p_rsa_ctx,                                         /* RSA context */
  ...
  PRINTF("[INFO] Step 2.1: Compute and verify the message using regular private key representation COMPLETED.\n");
  /* Verify API returned value */
  if (retval != CMOX_RSA_SUCCESS)
  {
    goto _app_process_exit;
  ...
  /** ########## Step 2.2 ##########
    * Computes and verifies the message using CRT private key representation
    */
  ...
  PRINTF("[INFO] Step 2.2: Compute and verify the message using CRT private key representation COMPLETED.\n");
  ...
  /** ########## Step 2.3 ##########
    * Computes and verifies the message using the public key representation
    */
  ...
  retval = cmox_rsa_pkcs1v22_encrypt(&p_rsa_ctx,                               /* RSA context */
                                     &Rsa_Key,                                 /* RSA key to use */
  ...
  PRINTF("[INFO] Step 2.3: Compute and verify the message using public key representation COMPLETED.\n");
