...
Example Step 2
    [Documentation]    Demonstrates how to use the STM32 Cryptographic library to encrypt and to decrypt
    ...
    Read Console Until    [INFO] Step 2.3: Compute and verify the message using public key representation COMPLETED.
