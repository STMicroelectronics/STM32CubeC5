...
*** Settings ***
Documentation       Automatic test for example_stcryptolib_cipher_rsa_v2_2.
...
Example Step 2
    [Documentation]    2.1: Compute and verify the message using regular private key representation COMPLETED.
    ...    2.2: Compute and verify the message using CRT private key representation COMPLETED.
    ...    2.3: Compute and verify the message using public key representation COMPLETED.
    Comment    ExecStatus value is then EXEC_STATUS_INIT_OK
    ...    but becomes immediately EXEC_STATUS_OK as there is no delay after.
