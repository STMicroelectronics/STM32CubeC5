...
# __Example: *stcryptolib_integrity_hash_sha2*__
...
How to use the STM32 Cryptographic library to digest a message using the SHA256 algorithm.
...
__Initialization phase__: At main program start, the `mx_system_init()` function is called. It initializes the peripherals, nonvolatile memory (such as flash memory, NVM, or external memories), MPU regions (if applicable), the system clock, and the SysTick.
 ...
 __Step 2__: Demonstrates how to use the STM32 Cryptographic library to digest a message using the SHA256 compliant algorithm in two ways:
