...
# __Example: *stcryptolib_integrity_hash_sm3*__
...
How to use the STM32 Cryptographic library to digest a message using the SM3 algorithm.
...
__Initialization phase__: At main program start, the `mx_system_init()` function is called. It initializes the peripherals, nonvolatile memory (such as flash memory, NVM, or external memories), MPU regions (if applicable), the system clock, and the SysTick.
 ...
 __Step 2__: Demonstrates how to use the STM32 Cryptographic library to digest a message using the SM3 compliant algorithm in two ways:
...
> **_NOTE:_** NIST vectors examples for SM3 are taken from: "The SM3 Cryptographic Hash Function - draft-oscca-cfrg-sm3-02", available at: https://datatracker.ietf.org/doc/html/draft-oscca-cfrg-sm3-02
