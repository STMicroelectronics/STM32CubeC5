...
Example Step 2
    ...
    Read Console Until    [INFO] Step 2.1: Computation and verification of the user identity hash (ZA) COMPLETED.
    Read Console Until    [INFO] Step 2.2: Computation and verification of the digest of a known message COMPLETED.
    Read Console Until    [INFO] Step 2.3: Computation and verification of the signature of the computed digest of a known message using a known random COMPLETED.
    Read Console Until    [INFO] Step 2.4: Computation and verification of the signature of the computed digest of a known message using a true random COMPLETED.
