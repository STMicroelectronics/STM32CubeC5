/**
  ******************************************************************************
  * @file    cmox_rsa_pkcs1v22.h
  * @brief   Header file for RSA PKCS#1 v2.2 definitions and functions.
  ******************************************************************************
  * @attention
  *
...
#ifndef CMOX_RSA_PKCS1V22_H
#define CMOX_RSA_PKCS1V22_H
...
/**
  * @defgroup CMOX_RSA_PKCS1V22 RSA PKCS#1 v2.2 standard
  * @{
  */

/**
  * @brief Hash algorithms to use with RSA PKCS#1 API.
  * @defgroup CMOX_RSA_PKCS1V22_HASH Hash functions to use in RSA PKCS#1 v2.2
  * @{
  */

/**
  * @brief SHA1 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA1;
/**
  * @brief SHA224 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA224;
/**
  * @brief SHA256 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA256;
/**
  * @brief SHA384 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA384;
/**
  * @brief SHA512 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA512;
/**
  * @brief SHA512/224 Hash structure for the RSA PKCS#1 v2.2 functions.
  */
...
/**
  ...
  */
extern const cmox_rsa_pkcs1v22_hash_t CMOX_RSA_PKCS1V22_HASH_SHA512_256;
...
/**
  * @defgroup CMOX_RSA_PKCS1V22_PUBLIC_METHODS RSA PKCS#1 v2.2 public method prototypes
  * @{
  */

/**
  * @brief       Sign a message using PKCS#1 v2.2.
  ...
  */
cmox_rsa_retval_t cmox_rsa_pkcs1v22_sign(cmox_rsa_handle_t              *P_pRsaCtx,
                                         const cmox_rsa_key_t           *P_pPrivKey,
                                         const uint8_t                  *P_pDigest,
                                         const cmox_rsa_pkcs1v22_hash_t P_HashId,
...
/**
  * @brief       Verify a message signed with PKCS#1 v2.2.
  * @param[in]   P_pRsaCtx       Context for RSA operations
  ...
  * @retval      CMOX_RSA_ERR_MEMORY_FAIL           Not enough memory
  * @retval      CMOX_RSA_ERR_INTERNAL              Something went wrong during internal computations (e.g. hash)
  ...
  */
cmox_rsa_retval_t cmox_rsa_pkcs1v22_verify(cmox_rsa_handle_t              *P_pRsaCtx,
...
/**
  * @brief       Encrypt a message using PKCS#1 v2.2.
  * @param[in]   P_pRsaCtx       Context for RSA operations
  * @param[in]   P_pPubKey       Public Key
  ...
  * @param[in]   P_pRandom       Random buffer
  * @param[in]   P_RandomLen     Random Length (in Bytes)
  * @param[in]   P_pLabel        Label (Optional)
  * @param[in]   P_LabelLen      Label Length (in Bytes)
  ...
  * @retval      CMOX_RSA_ERR_INTERNAL              Something went wrong during internal computations (e.g. hash)
  */
cmox_rsa_retval_t cmox_rsa_pkcs1v22_encrypt(cmox_rsa_handle_t               *P_pRsaCtx,
                                            const cmox_rsa_key_t            *P_pPubKey,
                                            ...
                                            const uint8_t                   *P_pRandom,
                                            size_t                          P_RandomLen,
                                            const uint8_t                   *P_pLabel,
                                            size_t                          P_LabelLen,
                                            uint8_t                         *P_pOutput,
                                            size_t                          *P_pOutputLen);

/**
  * @brief       Decrypt a message using PKCS#1 v2.2.
  * @param[in]   P_pRsaCtx       Context for RSA operations
  * @param[in]   P_pPrivKey      Private Key (standard or CRT)
  ...
  * @retval      CMOX_RSA_ERR_MODULUS_TOO_SHORT     Modulus too short for the message to decrypt
  */
cmox_rsa_retval_t cmox_rsa_pkcs1v22_decrypt(cmox_rsa_handle_t               *P_pRsaCtx,
                                            const cmox_rsa_key_t            *P_pPrivKey,
                                            const uint8_t                   *P_pInput,
                                            size_t                          P_InputLen,
                                            const cmox_rsa_pkcs1v22_hash_t  P_HashId,
