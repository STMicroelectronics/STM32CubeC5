...
/**
  ...
  * @note CBC mode of operation will apply CS2 ciphertext stealing in case
  *       the input length is greater than 16 bytes and not multiple of
  *       16 bytes. After CS2 is applied, no more appends are allowed.
  *       Refer to NIST SP 800-38A Addendum.
