/**
  ******************************************************************************
  * @file    lps22hh_io.h
  * @brief   LPS22HH IO header driver file for SPI.
  ******************************************************************************
  * @attention
  *
...
#define LPS22HH_USE_SPI_POLL                /*!< Use SPI in polling mode             */
#define LPS22HH_SPI_POLL_TIMEOUT 0x1000     /*!< Default SPI timeout in polling mode */
...
struct lps22hh_io_s
{
  hal_spi_handle_t *hspi;      /*!< SPI handle                */
  hal_gpio_t  cs_port;         /*!< HW control pin            */
  uint32_t cs_pin;             /*!< HW control port           */
